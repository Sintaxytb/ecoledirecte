...
(function () {
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > g.getListenerIndex(d)) {
                    ...
                    h.fn = d;
                    h.priority = f;
                    for (var t = g.length - 1; 0 <= t; t--) if (g[t].priority <= f) return g.splice(t + 1, 0, h), {removeListener: k};
                    g.unshift(h)
                }
                ...
                return function (f, h, k) {
                    ...
                    if (g) {
                        var t = g.listeners;
                        if (t.length) for (var t = t.slice(0), r, q = 0; q < t.length; q++) {
                            if (g.errorProof) try {
                                r = t[q].call(this, k, h, b, l)
                            } catch (v) {
                            } else r = t[q].call(this, k, h, b, l);
                            !1 === r ? m = 1 : "undefined" != typeof r && (h = r);
                            if (a || m) break
                        }
                    }
                ...
                var m = e(this)[a];
                if (m) {
                    var l = m.getListenerIndex(b);
                    0 <= l && m.listeners.splice(l, 1)
                }
        ...
        var a = navigator.userAgent.toLowerCase(), e = a.match(/edge[ \/](\d+.?\d*)/), b = -1 < a.indexOf("trident/"),
            b = !(!e && !b), b = {
                ie: b,
                edge: !!e,
        ...
        var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, d = /</g, m = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            f = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, h = function (a, g) {
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var h = 1; h < g; h++) {
                    var c = arguments[h], d;
                    for (d in c) if (!0 === b || null == a[d]) if (!f || d in f) a[d] = c[d]
                }
                return a
            },
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var g, b = [], f = 0; f < a.length; f++) if (g = a[f]) /@import|[{}]/.test(g) ? b.push("\x3cstyle\x3e" + g + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + g + '"\x3e');
                return b.join("")
            },
            ...
            transformPlainTextToHtml: function (a, g) {
                var b = g == CKEDITOR.ENTER_BR, f = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    f = f.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = g == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var c = /\n{2}/g;
                    if (c.test(f)) var d = "\x3c" + h + "\x3e", e = "\x3c/" + h + "\x3e",
                        f = d + f.replace(c, function () {
                            return e + d
                        }) + e
                }
                f = f.replace(/\n/g, "\x3cbr\x3e");
                b || (f = f.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function (a) {
            ...
            createClass: function (a) {
                var g = a.$, b = a.base, f = a.privates || a._, h = a.proto;
                a = a.statics;
                !g && (g = function () {
                    b && this.base.apply(this, arguments)
                });
                if (f) var c = g, g = function () {
            ...
            normalizeCssText: function (a, g) {
                var b = [], f, h = CKEDITOR.tools.parseCssText(a, !0, g);
                for (f in h) b.push(f + ":" + h[f]);
                b.sort();
                return b.length ? b.join(";") + ";" : ""
            },
            convertRgbToHex: function (a) {
                return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function (a, b, f, h) {
                    a = [b, f, h];
            ...
            parseCssText: function (a, g, b) {
                var f = {};
                b && (b = new CKEDITOR.dom.element("span"), b.setAttribute("style", a), a = CKEDITOR.tools.convertRgbToHex(b.getAttribute("style") || ""));
                if (!a || ";" == a) return f;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, b, h) {
                    g && (b = b.toLowerCase(), "font-family" == b && (h = h.toLowerCase().replace(/["']/g, "").replace(/\s*,\s*/g, ",")), h = CKEDITOR.tools.trim(h));
                    f[b] = h
                });
                return f
            },
            ...
            convertArrayToObject: function (a, g) {
                ...
                for (var f = 0, h = a.length; f < h; ++f) b[a[f]] = g;
                return b
            },
            fixDomain: function () {
                for (var a; ;) try {
            ...
            enableHtml5Elements: function (a, g) {
                for (var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), f = b.length, h; f--;) h = a.createElement(b[f]), g && a.appendChild(h)
            },
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var g = document.cookie.split(";"), b, f, h = 0; h < g.length; h++) if (b = g[h].split("\x3d"), f = decodeURIComponent(CKEDITOR.tools.trim(b[0]).toLowerCase()), f === a) return decodeURIComponent(1 < b.length ? b[1] : "");
                return null
            },
        ...
        var a = CKEDITOR.tools.extend, e = function (a, g) {
                ...
                table: 1,
                ul: 1
            }, m = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, l = {}, f = {"#": 1},
        ...
        e = {
            ...
            h5: b,
            h6: b,
            head: a({title: 1, base: 1}, m),
            header: c,
            hgroup: {h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1},
            hr: l,
            html: a({head: 1, body: 1}, c, m),
            i: b,
            iframe: f,
            img: l,
            input: l,
        ...
        a.removeCustomData = function (a) {
            var c = this.$["data-cke-expando"], c = c && e[c], d, m;
            c && (d = c[a], m = a in c, delete c[a]);
            return m ? d : null
        };
        ...
        appendTo: function (a, e) {
            ...
            function e(a, f) {
                var h = f ? a.nextSibling : a.previousSibling;
                return h && h.nodeType == CKEDITOR.NODE_TEXT ? b(h) ? e(h, f) : h : null
            }
            ...
            do a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (m || b(c)) || (d++, m = c.nodeType == CKEDITOR.NODE_TEXT); while (c = c.previousSibling);
            return d
            ...
            for (var a; this.getFirst && (a = this.getFirst());) {
                if (a.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (e) e.length < b && (a.split(b - e.length), this.$.removeChild(this.$.firstChild)); else {
                        a.remove();
                        continue
                    }
                }
        ...
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
                var d = a[c];
                if (e) for (var m = -1, l = 0; l < b.childNodes.length; l++) {
                    var f = b.childNodes[l];
                    if (!0 !== e || 3 != f.nodeType || !f.previousSibling || 3 != f.previousSibling.nodeType) if (m++, m == d) {
                        b = f;
                        break
                    }
        ...
        var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            m = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[d] = e;
        m[b] = 1;
        ...
        var c = e.getCustomData("list_marker_names"), d = e.getCustomData("list_marker_id"), m;
        for (m in c) e.removeCustomData(m);
        ...
        function c(a) {
            for (var b = 0, c = 0, g = l[a].length; c < g; c++) b += parseInt(this.getComputedStyle(l[a][c]) || 0, 10) || 0;
            return b
        }

        var d = document.createElement("_").classList,
            d = "undefined" !== typeof d && null !== String(d.add).match(/\[Native code\]/gi), m = /[\n\t\r]/g;
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: d ? function (a) {
                ...
                h && a(h, b) && ((h = h.replace(new RegExp("(?:^|\\s+)" + b + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class", h) : this.removeAttribute("class"));
                return this
            }, hasClass: function (b) {
                ...
                function a(b, c, g) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        for (var f = []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();) if (f.push(c), c = g ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return;
                        if (b.isIdentical(c)) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(), l = g.$.documentElement,
                        v = l.clientTop || d.$.clientTop || 0, p = l.clientLeft || d.$.clientLeft || 0, w = !0;
                    CKEDITOR.env.ie && (w = g.getDocumentElement().contains(this), g = g.getBody().contains(this), w = e && g || !e && w);
                    w && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || l.scrollLeft, c = d.$.scrollTop || l.scrollTop) : (c = e ? d.$ : l, b = c.scrollLeft, c = c.scrollTop), b = m.left + b - p, c = m.top + c - v)
                } else for (v = this, p = null; v && "body" != v.getName() && "html" != v.getName();) {
                    b += v.$.offsetLeft - v.$.scrollLeft;
                    c += v.$.offsetTop - v.$.scrollTop;
                    v.equals(this) || (b += v.$.clientLeft || 0, c += v.$.clientTop || 0);
                    for (; p && !p.equals(v);) b -= p.$.scrollLeft, c -= p.$.scrollTop, p = p.getParent();
                    p = v;
                    v = (m = v.$.offsetParent) ? new CKEDITOR.dom.element(m) : null
                }
                a && (m = this.getWindow(), v = a.getWindow(), !m.equals(v) && m.$.frameElement && (a = (new CKEDITOR.dom.element(m.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                ...
                e = a.getWindow();
                d = v(this, e);
                var z = v(a, e), B = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var u = a.$.clientHeight, y = a.$.clientWidth;
                e = d.x - p(this, "left") - z.x || 0;
                m = d.y - p(this, "top") - z.y || 0;
                g = d.x + g + p(this, "right") - (z.x + y) || 0;
                d = d.y + B + p(this, "bottom") - (z.y + u) || 0;
                (0 > m || 0 < d) && l(0, !0 === b ? m : !1 === b ? d : 0 > m ? m : d);
                ...
                for (var g = 0; g < c.length; g++) {
                    var d = c[g], e = d.nodeName.toLowerCase(), m;
                    if (!(e in b)) if ("checked" == e && (m = this.getAttribute(e))) a.setAttribute(e, m); else if (!CKEDITOR.env.ie || this.hasAttribute(e)) m = this.getAttribute(e), null === m && (m = d.nodeValue), a.setAttribute(e, m)
                }
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var f = g.startOffset, k = g.endOffset, h, e = this.guard, n = this.type,
                m = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var l = c.type == CKEDITOR.NODE_ELEMENT ? c : c.getParent(),
                    A = c.type == CKEDITOR.NODE_ELEMENT ? c.getChild(k) : c.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !l.equals(a)) && (!A || !a.equals(A)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(g.root))
                }
            }
            if (a && !this._.guardRTL) {
                var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    G = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !C.equals(a)) && (!G || !a.equals(G)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(g.root))
                }
            }
            var F = a ? this._.guardRTL : this._.guardLTR;
            h = e ? function (a, b) {
                return !1 === F(a, b) ? !1 : e(a, b)
            } : F;
            this.current ? c = this.current[m](!1, n, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < k ? c.getChild(k - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, n, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(f)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))), c && !1 === h(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        var d = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.whitespaces(),
            l = CKEDITOR.dom.walker.bookmark(), f = CKEDITOR.dom.walker.temp(), h = function (a) {
                return l(a) || m(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty)
            };
        ...
        function e(a, b, c, d, f) {
            function k(a, b, g, c) {
                ...
                if (c && m) return d;
                u || c ? b.append(a.clone(!0, f), g) : (a.remove(), l && b.append(a));
                return d
            }

            function h() {
                var a, b, g, c = Math.min(D.length, N.length);
                for (a = 0; a < c; a++) if (b = D[a], g = N[a], !b.equals(g)) return a;
                return a - 1
            }

            function e() {
                var b = R - 1, c = F && I && !y.equals(E);
                b < P - 1 || b < T - 1 || c ? (c ? a.moveToPosition(E, CKEDITOR.POSITION_BEFORE_START) : T == b + 1 && G ? a.moveToPosition(N[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(N[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = D[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({startNode: c}))) : a.collapse(!0)
            }

            a.optimizeBookmark();
            var m = 0 === b, l = 1 == b, u = 2 == b;
            b = u || l;
            var y = a.startContainer, E = a.endContainer, x = a.startOffset, A = a.endOffset, C, G, F, I, H, K;
            if (u && E.type == CKEDITOR.NODE_TEXT && y.equals(E)) y = a.document.createText(y.substring(x, A)), c.append(y); else {
                E.type == CKEDITOR.NODE_TEXT ? u ? K = !0 : E = E.split(A) : 0 < E.getChildCount() ? A >= E.getChildCount() ? (E = E.getChild(A - 1), G = !0) : E = E.getChild(A) : I = G = !0;
                y.type == CKEDITOR.NODE_TEXT ? u ? H = !0 : y.split(x) : 0 < y.getChildCount() ? 0 === x ? (y = y.getChild(x), C = !0) : y = y.getChild(x - 1) : F = C = !0;
                for (var D = y.getParents(), N = E.getParents(), R = h(), P = D.length - 1, T = N.length - 1, O = c, Y, M, W, U = -1, J = R; J <= P; J++) {
                    M = D[J];
                    W = M.getNext();
                    for (J != P || M.equals(N[J]) && P < T ? b && (Y = O.append(M.clone(0, f))) : C ? k(M, O, !1, F) : H && O.append(a.document.createText(M.substring(x))); W;) {
                        if (W.equals(N[J])) {
                            U = J;
                            break
                        }
                ...
                O = c;
                for (J = R; J <= T; J++) if (c = N[J], W = c.getPrevious(), c.equals(D[J])) b && (O = O.getChild(0)); else {
                    J != T || c.equals(D[J]) && T < P ? b && (Y = O.append(c.clone(0, f))) : G ? k(c, O, !1, I) : K && O.append(a.document.createText(c.substring(0, A)));
                    if (J > U) for (; W;) W = k(W, O, !0);
                    O = Y
                }
                u || e()
            }
        ...
        function b() {
            ...
            return function (f) {
                return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(m) ? !1 : !0
            }
        }
        ...
        var m = {
                ...
                u: 1,
                "var": 1
            }, l = CKEDITOR.dom.walker.bogus(), f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.editable(),
            k = CKEDITOR.dom.walker.ignored(!0);
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b, c, d, f, k = this.collapsed;
                b = this.document.createElement("span");
                b.data("cke-bookmark", 1);
                b.setStyle("display", "none");
                b.setHtml("\x26nbsp;");
                a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (k ? "C" : "S")));
                k || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), f = this.clone(), f.collapse(), f.insertNode(c));
                f = this.clone();
                f.collapse(!0);
                f.insertNode(b);
                c ? (this.setStartAfter(b), this.setEndBefore(c)) : this.moveToPosition(b, CKEDITOR.POSITION_AFTER_END);
                return {startNode: a ? d + (k ? "C" : "S") : b, endNode: a ? d + "E" : c, serializable: a, collapsed: k}
            }, createBookmark2: function () {
                function a(b) {
                    var g = b.container, d = b.offset, f;
                    f = g;
                    var k = d;
                    f = f.type != CKEDITOR.NODE_ELEMENT || 0 === k || k == f.getChildCount() ? 0 : f.getChild(k - 1).type == CKEDITOR.NODE_TEXT && f.getChild(k).type == CKEDITOR.NODE_TEXT;
                    f && (g = g.getChild(d - 1), d = g.getLength());
                    if (g.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a:{
                            for (f = g; d--;) if (k = f.getChild(d).getIndex(!0), 0 <= k) {
                                d = k;
                                break a
                            }
                            d = -1
                    ...
                    if (g.type == CKEDITOR.NODE_TEXT) {
                        f = g;
                        for (k = 0; (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;) k += f.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
                        f = k;
                        g.getText() ? d += f : (k = g.getPrevious(c), f ? (d = f, g = k ? k.getNext() : g.getParent().getFirst()) : (g = g.getParent(), d = k ? k.getIndex(!0) + 1 : 0))
                    }
                    b.container = g;
                    b.offset = d
                }
                ...
                return function (c) {
                    var d = this.collapsed, f = {container: this.startContainer, offset: this.startOffset},
                        k = {container: this.endContainer, offset: this.endOffset};
                    c && (a(f), b(f, this.root), d || (a(k), b(k, this.root)));
                    return {
                        start: f.container.getAddress(c),
                        end: d ? null : k.container.getAddress(c),
                ...
                if ((!a || f) && c && c.type == CKEDITOR.NODE_TEXT) {
                    if (d) if (d >= c.getLength()) d = c.getIndex() + 1, c = c.getParent(); else {
                        var k = c.split(d), d = c.getIndex() + 1, c = c.getParent();
                        this.startContainer.equals(this.endContainer) ? this.setEnd(k, this.endOffset - this.startOffset) : c.equals(this.endContainer) && (this.endOffset += 1)
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var k = function (a, b) {
                            ...
                            for (c.guard = function (a) {
                                ...
                                C = g != a ? g.getText() : g.substring(b);
                                if (d.test(C)) return !1
                            }
                            return !0
                        };
                        if (this.collapsed) break;
                        var h = this.getCommonAncestor(), e = this.root, m, l, u, y, E, x = !1, A, C;
                        A = this.startContainer;
                        var G = this.startOffset;
                        A.type == CKEDITOR.NODE_TEXT ? (G && (A = !CKEDITOR.tools.trim(A.substring(0, G)).length && A, x = !!A), A && ((y = A.getPrevious()) || (u = A.getParent()))) : (G && (y = A.getChild(G - 1) || A.getLast()), y || (u = A));
                        for (u = c(u); u || y;) {
                            if (u && !y) {
                                !E && u.equals(h) && (E = !0);
                                if (f ? u.isBlockBoundary() : !e.contains(u)) break;
                                x && "inline" == u.getComputedStyle("display") || (x = !1, E ? m = u : this.setStartBefore(u));
                                y = u.getPrevious()
                            }
                            for (; y;) if (A = !1, y.type == CKEDITOR.NODE_COMMENT) y = y.getPrevious(); else {
                                if (y.type == CKEDITOR.NODE_TEXT) C = y.getText(), d.test(C) && (y = null), A = /[\s\ufeff]$/.test(C); else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && y.is("br")) && !y.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                                    C = y.getText();
                                    if (d.test(C)) y = null; else for (var G = y.$.getElementsByTagName("*"), F = 0, I; I = G[F++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                        y = null;
                                        break
                                    }
                                    y && (A = !!C.length)
                                } else y = null;
                                A && (x ? E ? m = u : u && this.setStartBefore(u) : x = !0);
                                if (y) {
                                    A = y.getPrevious();
                                    if (!u && !A) {
                                        u = y;
                        ...
                        u = y = null;
                        E = x = !1;
                        A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(G)).length ? x = !0 : (x = !A.getLength(), G == A.getLength() ? (y = A.getNext()) || (u = A.getParent()) : k(A, G) && (u = A.getParent())) : (y = A.getChild(G)) || (u = A);
                        for (; u || y;) {
                            if (u && !y) {
                                !E && u.equals(h) && (E = !0);
                                if (f ? u.isBlockBoundary() : !e.contains(u)) break;
                                x && "inline" == u.getComputedStyle("display") || (x = !1, E ? l = u : u && this.setEndAfter(u));
                                y = u.getNext()
                            }
                            for (; y;) {
                                A = !1;
                                if (y.type == CKEDITOR.NODE_TEXT) C = y.getText(), k(y, 0) || (y = null), A = /^[\s\ufeff]/.test(C); else if (y.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < y.$.offsetWidth || b && y.is("br")) && !y.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                                        C = y.getText();
                                        if (d.test(C)) y = null; else for (G = y.$.getElementsByTagName("*"), F = 0; I = G[F++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                            y = null;
                                            break
                                        }
                                        y && (A = !!C.length)
                        ...
                        m && l && (h = m.contains(l) ? l : m, this.setStartBefore(h), this.setEndAfter(h));
                        break;
                    case CKEDITOR.ENLARGE_BLOCK_CONTENTS:
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        u = new CKEDITOR.dom.range(this.root);
                        e = this.root;
                        u.setStartAt(e, CKEDITOR.POSITION_AFTER_START);
                        u.setEnd(this.startContainer, this.startOffset);
                        u = new CKEDITOR.dom.walker(u);
                        var H, K,
                            D = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            N = null, R = function (a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (N) {
                                    if (N.equals(a)) {
                                        N = null;
                                        return
                                    }
                                } else N = a; else if (N) return;
                                var b = D(a);
                                b || (H = a);
                                return b
                            }, f = function (a) {
                        ...
                        u = u.lastBackward();
                        H = H || e;
                        this.setStartAt(H, !H.is("br") && (!u && this.checkStartOfBlock() || u && H.contains(u)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        u = this.clone();
                        u.collapse();
                        u.setEndAt(e, CKEDITOR.POSITION_BEFORE_END);
                        u = new CKEDITOR.dom.walker(u);
                        u.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : R;
                        H = N = K = null;
                        u = u.lastForward();
                        H = H || e;
                        this.setEndAt(H, !u && this.checkEndOfBlock() || u && H.contains(u) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
                        K && this.setEndAfter(K)
                }
            }, shrink: function (a, b, c) {
                if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT;
                    var d = this.clone(), f = this.startContainer, k = this.endContainer, h = this.startOffset,
                        e = this.endOffset, m = 1, l = 1;
                    f && f.type == CKEDITOR.NODE_TEXT && (h ? h >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), m = 0) : d.setStartBefore(f));
                    k && k.type == CKEDITOR.NODE_TEXT && (e ? e >= k.getLength() ? d.setEndAfter(k) : (d.setEndAfter(k), l = 0) : d.setEndBefore(k));
                    var d = new CKEDITOR.dom.walker(d), u = CKEDITOR.dom.walker.bookmark();
                    ...
                    d.guard = function (b, d) {
                        if (u(b)) return !0;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(y) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
                        d || b.type != CKEDITOR.NODE_ELEMENT || (y = b);
                        return !0
                    };
                    m && (f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, k = d.block, h = null;
                if (!c.blockLimit.equals(d.blockLimit)) return null;
                "br" != a && (f || (f = this.fixBlock(!0, a), k = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), k || (k = this.fixBlock(!1, a)));
                c = f && this.checkStartOfBlock();
                d = k && this.checkEndOfBlock();
                this.deleteContents();
                f && f.equals(k) && (d ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(k, CKEDITOR.POSITION_AFTER_END), k = null) : c ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (k = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
                return {previousBlock: f, nextBlock: k, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: h}
                ...
                var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.dom.walker.bookmark(!1);
                return function (b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), f = d.block || d.blockLimit, k; f && !f.equals(d.root) && !f.getFirst(a(f));) k = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = k;
                    this.moveToBookmark(c)
                }
            }(), startPath: function () {
        ...
        function b(a, c, d, f) {
            ...
            if (!f) return 0;
            if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) && !h.check(c)) return b(a, c, d, f.remaining);
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; p;) {
                    var w = 0, z = p.hasAscendant("pre"), B = p.type != CKEDITOR.NODE_ELEMENT, u = 0;
                    if (B) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (B = 0); else {
                        var y = p.getName();
                        if (CKEDITOR.dtd.$block[y] && "false" == p.getAttribute("contenteditable")) {
                            g = p;
                            b(this, a, g);
                            break
                        } else if (p.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                            if ("br" == y) B = 1; else if (!e && !p.getChildCount() && "hr" != y) {
                                g = p;
                                l = p.equals(v);
                                break
                            }
                            e && (e.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), "br" != y && (this._.nextNode = p));
                            w = 1
                        } else {
                            if (p.getFirst()) {
                                e || (e = this.range.clone(), e.setStartAt(p, CKEDITOR.POSITION_BEFORE_START));
                                p = p.getFirst();
                                continue
                            }
                            B = 1
                    ...
                    l = (!w || B) && p.equals(v);
                    if (e && !w) for (; !p.getNext(f) && !l;) {
                        y = p.getParent();
                        if (y.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                            w = 1;
                            B = 0;
                            l || y.equals(v);
                    ...
                    B && e.setEndAt(p, CKEDITOR.POSITION_AFTER_END);
                    p = this._getNextSourceNode(p, u, v);
                    if ((l = !p) || w && e) break
                }
                if (!g) {
                    ...
                    w = {div: 1, th: 1, td: 1};
                    g = g.block;
                    !g && p && !this.enforceRealBlocks && w[p.getName()] && e.checkStartOfBlock() && e.checkEndOfBlock() && !p.equals(e.root) ? g = p : !g || this.enforceRealBlocks && g.is(h) ? (g = this.range.document.createElement(a), e.extractContents().appendTo(g), g.trim(), e.insertNode(g), r = q = !0) : "li" != g.getName() ? e.checkStartOfBlock() && e.checkEndOfBlock() || (g = g.clone(!1), e.extractContents().appendTo(g), g.trim(), q = e.splitBlock(), r = !q.wasStartOfBlock, q = !q.wasEndOfBlock, e.insertNode(g)) : l || (this._.nextNode = g.equals(v) ? null : this._getNextSourceNode(e.getBoundaryNodes().endNode, 1, v))
                }
                ...
                q && (r = g.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() && (!CKEDITOR.env.needsBrFiller || r.getPrevious(m) || r.getNext(m)) && r.remove();
                this._.nextNode || (this._.nextNode = l || g.equals(v) || !v ? null : this._getNextSourceNode(g, 1, v));
                return g
        ...
        function a(a, b, c, d, g) {
            ...
            for (f in b) {
                e = b[f];
                e = "boolean" == typeof e ? {} : "function" == typeof e ? {match: e} : F(e);
                "$" != f.charAt(0) && (e.elements = f);
                c && (e.featureName = c.toLowerCase());
                var k = e;
                k.elements = l(k.elements, /\s+/) || null;
                k.propertiesOnly = k.propertiesOnly || !0 === k.elements;
                var h = /\s*,\s*/, m = void 0;
                for (m in K) {
                    k[m] = l(k[m], h) || null;
                    var u = k, y = D[m], v = l(k[D[m]], h), B = k[m], p = [], E = !0, n = void 0;
                    v ? E = !1 : v = {};
                    for (n in B) "!" == n.charAt(0) && (n = n.slice(1), p.push(n), v[n] = !0, E = !1);
                    for (; n = p.pop();) B[n] = B["!" + n], delete B["!" + n];
                    u[y] = (E ? !1 : v) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (m in D) {
                    ...
                    v = [];
                    B = void 0;
                    for (B in y) -1 < B.indexOf("*") ? v.push(new RegExp("^" + B.replace(/\*/g, ".*") + "$")) : v.push(B);
                    y = v;
                    y.length && (k[h] = y, u = !1)
                }
                k.nothingRequired = u;
                k.noProperties = !(k.attributes || k.classes || k.styles);
                if (!0 === f.elements || null === f.elements) g[e ? "unshift" : "push"](f); else for (q in k = f.elements, delete f.elements, k) if (b[q]) b[q][e ? "unshift" : "push"](f); else b[q] = [f]
            }
        }
        ...
        function e(a, c, d, g) {
            if (!a.match || a.match(c)) if (g || f(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                ...
                if (a) if (!0 === a) a = !0; else {
                    for (var e = 0, k = c.length, h; e < k; ++e) h = c[e], g[h] || (g[h] = a(h));
                    a = !1
                } else a = !1;
                d.allClasses = a
            }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var g = !1, f = !0 === a, e = b.length; e--;) if (f || a(b[e])) b.splice(e, 1), g = !0;
                    a = g
                } else a = !1;
        ...
        function f(a, b) {
            ...
            var c, d, g, f;
            if (g = a.requiredClasses) for (f = b.classes, c = 0; c < g.length; ++c) if (d = g[c], "string" == typeof d) {
        ...
        function g(a) {
            var b, c, d, g, f = {}, e = 1;
            for (a = I(a); b = a.match(N);) (c = b[2]) ? (d = n(c, "styles"), g = n(c, "attrs"), c = n(c, "classes")) : d = g = c = null, f["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: g
        ...
        function r(a, b, d, g) {
            ...
            if (g.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var h = 0, m = k.length, u; h < m; ++h) if (u = k[h](b)) {
                        k = u;
                        break a
                    }
                    k = void 0
            ...
            if (g.doTransform && (k = a._.transformations[b.name])) {
                t(b);
                for (h = 0; h < k.length; ++h) y(a, b, k[h]);
                v(b)
            }
            if (g.doFilter) {
                a:{
                    h = b.name;
                    m = a._;
                    a = m.allowedRules.elements[h];
                    k = m.allowedRules.generic;
                    h = m.disallowedRules.elements[h];
                    ...
                    if (a || k) {
                        t(b);
                        if (h) for (D = 0, B = h.length; D < B; ++D) if (!1 === c(h[D], b, l)) {
                            a = null;
                            break a
                        }
                        if (m) for (D = 0, B = m.length; D < B; ++D) c(m[D], b, l);
                        if (a) for (D = 0, B = a.length; D < B; ++D) e(a[D], b, l, u);
                        if (k) for (D = 0, B = k.length; D < B; ++D) e(k[D], b, l, u);
                        a = l
                    } else a = null
                }
                ...
                var E = a.validStyles;
                k = a.validClasses;
                var h = b.attributes, n = b.styles, m = b.classes;
                u = b.classBackup;
                var w = b.styleBackup, q, x, z = [], l = [], A = /^data-cke-/;
                D = !1;
                delete h.style;
                delete h["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (q in h) B[q] || (A.test(q) ? q == (x = q.replace(/^data-cke-saved-/, "")) || B[x] || (delete h[q], D = !0) : (delete h[q], D = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (q in n) a.allStyles || E[q] ? z.push(q + ":" + n[q]) : D = !0;
                    z.length && (h.style = z.sort().join("; "))
                } else w && (h.style = w);
                if (!a.allClasses || a.hadInvalidClass) {
                    for (q = 0; q < m.length; ++q) (a.allClasses || k[m[q]]) && l.push(m[q]);
                    l.length && (h["class"] = l.sort().join(" "));
                    u && l.length < u.split(/\s+/).length && (D = !0)
                } else u && (h["class"] = u);
                D && (f = 1);
                if (!g.skipFinalValidation && !p(b)) return d.push(b), 1
            }
        ...
        function u(a, b, c) {
            var d = a.name;
            if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (G.$block[d] || "tr" == d) if ("br" == b) a.previous && !B(a.previous) && (b = z(), b.insertBefore(a)), a.next && !B(a.next) && (b = z(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, g;
                b:{
                    g = G[b];
                    for (var f = 0, k = d.length, e; f < k; ++f) if (e = d[f], e.type == CKEDITOR.NODE_ELEMENT && !g[e.name]) {
                        g = !1;
                        break b
                    }
                    g = !0
                ...
                if (g) a.name = b, a.attributes = {}, c.push({check: "parent-down", el: a}); else {
                    g = a.parent;
                    for (var f = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == g.name, h, m, k = d.length; 0 < k;) e = d[--k], f && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && G.$inline[e.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                        check: "parent-down",
                        el: h
                    })), h.add(e, 0)) : (h = null, m = G[g.name] || G.span, e.insertAfter(a), g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT || m[e.name] || c.push({
                        check: "el-up",
                        el: e
                    }));
                    a.remove()
        ...
        function E(a, b) {
            var c = b.getDefinition(), d = c.attributes, g = c.styles, f, e, k, h;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), k = a.classes.join("|"); h = c.pop();) {
                if (-1 == k.indexOf(h)) return !1
            } else if (a.attributes[f] != d[f]) return !1;
            for (e in g) if (a.styles[e] != g[e]) return !1;
            return !0
        }
        ...
        var G = CKEDITOR.dtd, F = CKEDITOR.tools.copy, I = CKEDITOR.tools.trim, H = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b) b = g(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    d && (d = F(d), f.classes = d["class"] ? d["class"].split(/\s+/) : null, f.requiredClasses = f.classes, delete d["class"], f.attributes = d, f.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
                ...
                var g = this, f = [], e = this.editor && this.editor.config.protectedSource, k, h = !1,
                    m = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (k = r(g, a, f, m), k & 1) h = !0; else if (k & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var u, l, D;
                            if (e) for (l = 0; l < e.length; ++l) if ((D = d.match(e[l])) && D[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (u = d.children[0]).type == CKEDITOR.NODE_ELEMENT && r(g, u, c, m);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (var D; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? u(c, d, a) : c.remove();
                for (; l = a.pop();) if (c = l.el, c.parent) switch (D = G[c.parent.name] || G.span, l.check) {
                    case "it":
                        G.$removeEmpty[c.name] && !c.children.length ? u(c, d, a) : p(c) || u(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || u(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || u(c.parent, d, a)
                }
                return h
                ...
                if (!this.disabled && a) {
                    ...
                    for (g = 0; g < a.length; ++g) {
                        b = a[g];
                        var f = void 0, e = void 0, k = void 0, h = void 0, m = void 0, u = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e) k = b[e], "string" == typeof k ? (k = k.split(/\s*:\s*/), h = k[0], m = null, u = k[1]) : (h = k.check, m = k.left, u = k.right), f || (f = k, f = f.element ? f.element : h ? h.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element), m instanceof CKEDITOR.style && (m = A(m)), c.push({
                            check: h == f ? null : h,
                            left: m,
                            right: "string" == typeof u ? C(u) : u
                        });
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    f = d
                } else d = a.getDefinition(), f = d.styles, h = d.attributes || {}, f ? (f = F(f), h.style = CKEDITOR.tools.writeCssText(f, !0)) : f = {}, f = {
                    name: d.element,
                    attributes: h,
                ...
                var h = CKEDITOR.tools.clone(f), m = [], u;
                if (!1 !== b && (u = this._.transformations[f.name])) {
                    for (d = 0; d < u.length; ++d) y(this, f, u[d]);
                    v(f)
                }
                r(this, h, m, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < m.length ? !1 : CKEDITOR.tools.objectCompare(f.attributes, h.attributes, !0) ? !0 : !1;
                ...
                return function (c, d) {
                    ...
                    for (d || (g = g.reverse()); f = g.pop();) if (this.check(f)) return b[f];
        ...
        var K = {styles: 1, attributes: 1, classes: 1},
            D = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            N = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            R = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, P = /^cke:(object|embed|param)$/,
            T = /^(object|embed|param)$/, O = CKEDITOR.filter.transformationsTools = {
                ...
                }, matchesStyle: E, transform: function (a, b) {
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, g = c.attributes, f, e, h, k;
                        a.name = c.element;
                        for (f in g) if ("class" == f) for (c = a.classes.join("|"), h = g[f].split(/\s+/); k = h.pop();) -1 == c.indexOf(k) && a.classes.push(k); else a.attributes[f] = g[f];
        ...
        var a, e = function (b) {
            b = b.data;
            var d = b.getKeystroke(), e = this.keystrokes[d], l = this._.editor;
            a = !1 === l.fire("key", {keyCode: d, domEvent: b});
            a || (e && (a = !1 !== l.execCommand(e, {from: "keystrokeHandler"})), a || (a = !!this.blockedKeystrokes[d]));
        ...
        return {
            load: function (b, c, d, m) {
                ...
                var f = b.length, h = [], k = [], g = function (a) {
                    c && (l ? c.call(d, a) : c.call(d, h, k))
                };
                if (0 === f) g(!0); else {
                    var n = function (a, b) {
                        (b ? h : k).push(a);
                        0 >= --f && (m && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), g(b))
                    }, t = function (b, c) {
                        a[b] = 1;
                        var d = e[b];
                        delete e[b];
                        ...
                        if (a[b]) n(b, !0); else {
                            ...
                            if (!(1 < d.length)) {
                                ...
                                c && (CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? g.$.onreadystatechange = function () {
                                    if ("loaded" == g.$.readyState || "complete" == g.$.readyState) g.$.onreadystatechange = null, t(b, !0)
                                } : (g.$.onload = function () {
                                    setTimeout(function () {
                                        t(b, !0)
                                    }, 0)
        ...
        add: function (a, e) {
            ...
            for (var c = this.loaded, d = this.registered, m = [], l = {}, f = {}, h = 0; h < a.length; h++) {
                var k = a[h];
            ...
            CKEDITOR.scriptLoader.load(m, function (a, d) {
                if (d.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + l[d[0]].join(",") + '" was not found at "' + d[0] + '".');
                for (var g = 0; g < a.length; g++) for (var h = l[a[g]], k = 0; k < h.length; k++) {
                    var m = h[k];
                    f[m] = this.get(m);
                    c[m] = 1
                }
        ...
        return function (b, c, d) {
            var m = {}, l = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], g;
                    for (g in a) {
                        var f = a[g], t = f && f.requires;
                        if (!e[g]) {
                            if (f.icons) for (var r = f.icons.split(","), q = r.length; q--;) CKEDITOR.skin.addIcon(r[q], f.path + "icons/" + (CKEDITOR.env.hidpi && f.hidpi ? "hidpi/" : "") + r[q] + ".png");
                            e[g] = 1
                        }
                        if (t) for (t.split && (t = t.split(",")), f = 0; f < t.length; f++) m[t[f]] || b.push(t[f])
                    }
                    if (b.length) l.call(this, b); else {
                        for (g in m) f = m[g], f.onLoad && !f.onLoad._called && (!1 === f.onLoad() && delete m[g], f.onLoad._called = 1);
                        c && c.call(d || window, m)
                    }
                }, this)
            };
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var h in c) {
                    var k = c[h], m = k.lang, u = null, l = k.requires, D;
                    CKEDITOR.tools.isArray(l) && (l = l.join(","));
                    if (l && (D = l.match(e))) for (; l = D.pop();) CKEDITOR.error("editor-plugin-required", {
                        plugin: l.replace(",", ""),
                        requiredBy: h
                    });
                    m && !a.lang[h] && (m.split && (m = m.split(",")), 0 <= CKEDITOR.tools.indexOf(m, a.langCode) ? u = a.langCode : (u = a.langCode.replace(/-.*/, ""), u = u != a.langCode && 0 <= CKEDITOR.tools.indexOf(m, u) ? u : 0 <= CKEDITOR.tools.indexOf(m, "en") ? "en" : m[0]), k.langEntries && k.langEntries[u] ? (a.lang[h] = k.langEntries[u], u = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + u + ".js")));
                    g.push(u);
                    d.push(k)
                }
                CKEDITOR.scriptLoader.load(f, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++) for (var e = 0; e < d.length; e++) {
                        var k = d[e];
                        0 === f && g[e] && k.lang && k.langEntries && (a.lang[k.name] = k.langEntries[g[e]]);
                        if (k[c[f]]) k[c[f]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, g, f, e, k = 0; k < c.length; k++) {
                    var h = c[k], m = h.startContainer;
                    m.getName && "tr" == m.getName() ? (g || (g = m.getAscendant("table").clone(), g.append(m.getAscendant("tbody").clone()), d.append(g), g = g.findOne("tbody")), f && f.equals(m) || (f = m, e = m.clone(), g.append(e)), e.append(h.cloneContents())) : d.append(h.cloneContents())
                }
                ...
                for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, g = b.length; g--;) c = b[g], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
            }, addFeature: function (a) {
        ...
        function () {
            ...
            CKEDITOR.htmlParser.prototype = {
                onTagOpen: function () {
                    ...
                    for (var c, d, m = 0, l; c = this._.htmlPartsRegex.exec(b);) {
                        d = c.index;
                        if (d > m) if (m = b.substring(m, d), l) l.push(m); else this.onText(m);
                        m = this._.htmlPartsRegex.lastIndex;
                        if (d = c[1]) if (d = d.toLowerCase(), l && CKEDITOR.dtd.$cdata[d] && (this.onCDATA(l.join("")), l = null), !l) {
                            this.onTagClose(d);
                            continue
                        }
                        if (l) l.push(c[0]); else if (d = c[3]) {
        ...
        var e = CKEDITOR.tools.extend({
            ...
            c = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {
                ...
                ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td"
            };
        CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, f) {
            function h(a) {
                var b;
                if (0 < p.length) for (var c = 0; c < p.length; c++) {
                    var d = p[c], g = d.name, f = CKEDITOR.dtd[g], e = z.name && CKEDITOR.dtd[z.name];
                    e && !e[g] || a && f && !f[a] && CKEDITOR.dtd[a] ? g == z.name && (n(z, z.parent, 1), c--) : (b || (k(), b = 1), d = d.clone(), d.parent = z, z = d, p.splice(c, 1), c--)
                }
            }

            function k() {
                for (; w.length;) n(w.shift(), z)
            }
            ...
            function n(b, c, d) {
                c = c || z || v;
                var e = z;
                void 0 === b.previous && (t(c, b) && (z = c, q.onTagOpen(f, {}), b.returnPoint = c = z), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (u = !1), "textarea" == b.name && (B = !1));
                b.returnPoint ? (z = b.returnPoint, delete b.returnPoint) : z = d ? c : e
            }

            function t(a, b) {
                if ((a == v || "body" == a.name) && f && (!a.name || CKEDITOR.dtd[a.name][f])) {
                    var c, d;
            ...
            var q = new CKEDITOR.htmlParser,
                ...
                p = [], w = [], z = v, B = "textarea" == v.name, u = "pre" == v.name;
            q.onTagOpen = function (d, g, f, m) {
                g = new CKEDITOR.htmlParser.element(d, g);
                g.isUnknown && f && (g.isEmpty = !0);
                g.isOptionalClose = m;
                if (a(g)) p.push(g); else {
                    if ("pre" == d) u = !0; else {
                        if ("br" == d && u) {
                    ...
                    if ("br" == d) w.push(g); else {
                        for (; !(m = (f = z.name) ? CKEDITOR.dtd[f] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, g.isUnknown || z.isUnknown || m[d]);) if (z.isOptionalClose) q.onTagClose(f); else if (d in b && f in b) f = z.children, (f = f[f.length - 1]) && "li" == f.name || n(f = new CKEDITOR.htmlParser.element("li"), z), !g.returnPoint && (g.returnPoint = z), z = f; else if (d in CKEDITOR.dtd.$listItem && !r(d, f)) q.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1); else if (f in e && !r(d, f)) !g.returnPoint && (g.returnPoint = z), z = z.parent; else if (f in CKEDITOR.dtd.$inline && p.unshift(z), z.parent) n(z, z.parent, 1); else {
                            g.isOrphan = 1;
                            break
                        }
                        h(d);
            ...
            q.onTagClose = function (a) {
                for (var b = p.length - 1; 0 <= b; b--) if (a == p[b].name) {
                    p.splice(b, 1);
                    return
                }
                for (var c = [], d = [], g = z; g != v && g.name != a;) g._.isBlockLike || d.unshift(g), c.push(g), g = g.returnPoint || g.parent;
                if (g != v) {
            ...
            q.onText = function (a) {
                if (!(z._.hasInlineStarted && !w.length || u || B) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                var b = z.name, g = b ? CKEDITOR.dtd[b] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!B && !g["#"] && b in e) q.onTagOpen(d[b] || ""), q.onText(a); else {
                    k();
                    h();
                    u || B || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                    a = new CKEDITOR.htmlParser.text(a);
                    if (t(z, a)) this.onTagOpen(f, {}, 0, 1);
                    z.add(a)
                }
            };
        ...
        function e(b, c, d, e) {
            var l, f;
            for (l in c) (f = b[l]) || (f = b[l] = new a), f.add(c[l], d, e)
        }
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, l = 0; 3 > l; l++) if (e = d[l]) {
                        e = e.exec(a, c, this);
                        if (!1 === e) return null;
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                for (var e = [this.findIndex(c), 0], l = 0, f = a.length; l < f; l++) e.push({
                    value: a[l],
                    priority: c,
                    options: d
                });
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    e = Array.prototype.slice.call(arguments, 1), l = this.rules, f = l.length, h, k, g, n;
                for (n = 0; n < f; n++) if (d && (h = c.type, k = c.name), g = l[n], !(a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable)) {
                ...
                for (var d = 0, e = this.rules, l = e.length, f; c && d < l; d++) f = e[d], a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable || (c = c.replace(f.value[0], f.value[1]));
                return c
            }
        }
    }(),function () {
        function a(a, g) {
            ...
            function e(a, d) {
                return function (g) {
                    if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], h = b(g), u, l;
                        if (h) for (k(h, 1) && e.push(h); h;) m(h) && (u = c(h)) && k(u) && ((l = c(u)) && !m(l) ? e.push(u) : (f(D).insertAfter(u), u.remove())), h = h.previous;
                        for (h = 0; h < e.length; h++) e[h].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(g) : d)) D || CKEDITOR.env.needsBrFiller || g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? D || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem) ? (e = b(g), e = !e || "form" == g.name && "input" == e.name) : e = !1 : e = !1;
                        e && g.add(f(a))
                    }
                }
            }
            ...
            function k(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(p)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && D && (!b || a.parent.name in B) || !D && ((c = a.previous) && "br" == c.name || !c || m(c))) ? !0 : !1
            }

            var h = {elements: {}}, D = "html" == g, B = CKEDITOR.tools.extend({}, u), y;
            for (y in B) "#" in z[y] || delete B[y];
            for (y in B) h.elements[y] = e(D, a.config.fillEmptyBlocks);
            h.root = e(D, !1);
                ...
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in g || "data-cke-eol" in g) delete g["data-cke-bogus"]; else {
                            ...
                            var e = c(b);
                            !g && m(b.parent) ? l(b.parent, f(a)) : m(g) && e && !m(e) && f(a).insertBefore(g)
                        }
                    }
                }
            }(D);
        ...
        function v(a, b) {
            var c = [], d = b.config.protectedSource, g = b._.dataStore || (b._.dataStore = {id: 1}),
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, g) {
                return "\x3c" + c + d + "\x3e" + q(r(g), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            c.addRules(y);
            c.addRules(E, {applyToAll: !0});
            c.addRules(a(b, "data"), {applyToAll: !0});
            d.addRules(x);
            d.addRules(A, {applyToAll: !0});
            d.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = v(c, b), c = g(c, H), c = k(c), c = g(c, I), c = c.replace(D, "$1cke:$2"),
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var b = a.dataValue, c = new CKEDITOR.htmlParser.basicWriter;
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, e = b.filter, k = b.enterMode, h = b.protectedWhitespaces) : f = b;
                f || null === f || (f = g.editable().getName());
        ...
        var p = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", z = CKEDITOR.dtd,
            B = "caption colgroup col thead tfoot tbody".split(" "),
            u = CKEDITOR.tools.extend({}, z.$blockLimit, z.$block), y = {elements: {input: f, textarea: f}},
            E = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, x = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && "object" == b.name) {
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
            G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i,
            I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            H = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, K = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            D = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, R = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                for (; ;) {
                    l = e.name;
                    if (!(f = a.onElementName(b, l))) return this.remove(), !1;
                    e.name = f;
                ...
                var h, k;
                for (h in l) {
                    for (f = l[h]; ;) if (k = a.onAttributeName(b, h)) if (k != h) delete l[h], h = k; else break; else {
                        delete l[h];
                        break
                    }
                    k && (!1 === (f = a.onAttribute(b, e, k, f)) ? delete l[k] : l[k] = f)
                }
                e.isEmpty || this.filterChildren(a, !1, b);
                return !0
            }, filterChildren: b.filterChildren, writeHtml: function (a, b) {
                b && this.filter(b);
                var m = this.name, l = [], f = this.attributes, h, k;
                a.openTag(m, f);
                for (h in f) l.push([h, f[h]]);
                a.sortAttributes && l.sort(e);
                h = 0;
                for (k = l.length; h < k; h++) f = l[h], a.attribute(f[0], f[1]);
                ...
                for (var b = this.children.splice(a, this.children.length - a), e = this.clone(), l = 0; l < b.length; ++l) b[l].parent = e;
                e.children = b;
        ...
        var a = {}, e = /{([^}]+)}/g, b = /([\\'])/g, c = /\n/g, d = /\r/g;
        CKEDITOR.template = function (m) {
            if (a[m]) this.output = a[m]; else {
                var l = m.replace(b, "\\$1").replace(c, "\\n").replace(d, "\\r").replace(e, function (a, b) {
                    return "',data['" + b + "']\x3d\x3dundefined?'{" + b + "}':data['" + b + "'],'"
                });
                this.output = a[m] = Function("data", "buffer", "return buffer?buffer.push('" + l + "'):['" + l + "'].join('');")
            }
        }
        ...
        CKEDITOR.inlineAll = function () {
            var a, e, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, m = c.count(); d < m; d++) a = c.getItem(d), "true" == a.getAttribute("contenteditable") && (e = {
                element: a,
                config: {}
        ...
        function a(a, d, m, l) {
            ...
            a = CKEDITOR.dom.element.get(a);
            if (a.getEditor()) throw 'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.';
            var f = new CKEDITOR.editor(d, a, l);
            l == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), f._.required = a.hasAttribute("required"), a.removeAttribute("required"));
            m && f.setData(m, null, !0);
            f.on("loaded", function () {
                b(f);
                l == CKEDITOR.ELEMENT_MODE_REPLACE && f.config.autoUpdateElement && a.$.form && f._attachToForm();
        ...
        function b(a) {
            var b = a.name, e = a.element, l = a.elementMode, f = a.fire("uiSpace", {space: "top", html: ""}).html,
                ...
                b = CKEDITOR.dom.element.createFromHtml(k.output({
                    id: a.id,
                    name: b,
                    langDir: a.lang.dir,
                    langCode: a.langCode,
            ...
            l == CKEDITOR.ELEMENT_MODE_REPLACE ? (e.hide(), b.insertAfter(e)) : e.append(b);
            a.container = b;
        ...
        CKEDITOR.replaceAll = function () {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (l.name || l.id) {
                    ...
                    } else if ("function" == typeof arguments[0] && (e = {}, !1 === arguments[0](l, e))) continue;
                    this.replace(l, e)
                }
            }
        };
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            var e = this, l = this._.modes;
            if (a != e.mode && l && l[a]) {
                e.fire("beforeSetMode", a);
                if (e.mode) {
                    var f = e.checkDirty(), l = e._.previousModeData, h, k = 0;
                    e.fire("beforeModeUnload");
                    e.editable(0);
                    e._.previousMode = e.mode;
                    e._.previousModeData = h = e.getData(1);
                    "source" == e.mode && l == h && (e.fire("lockSnapshot", {forceUpdate: !0}), k = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, e, l) {
            var f = this.container, h = this.ui.space("contents"),
            ...
            l.setSize("width", a, !0);
            k && (k.style.width = "1%");
            var g = (l.$.offsetHeight || 0) - (h.$.clientHeight || 0), f = Math.max(b - (e ? 0 : g), 0);
            b = e ? b + g : b;
            h.setStyle("height", f + "px");
            k && (k.style.width = "100%");
            this.fire("resize", {
                outerHeight: b, contentsHeight: f, outerWidth: a || l.getSize("width")
            })
        };
        ...
        function a(a) {
            ...
            l(b, d.block, g) && k.collapsed && !k.getCommonAncestor().isReadOnly() && (d = k.clone(), d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), g = new CKEDITOR.dom.walker(d), g.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !g.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = k.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && k.select()
        }

        function e(a, b) {
            if (a.isFake) return 0;
            var d = b.block || b.blockLimit, g = d && d.getLast(c);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    d.focus();
                    d.fire("saveSnapshot");
                    var g = d.activeEnterMode, d = d.getSelection(), f = a.getName(), f = CKEDITOR.dtd.$block[f];
                    b || (b = d.getRanges()[0]);
                    ...
                    var c = this.editor, d = c.config.enterMode, g = a.getName(), f = CKEDITOR.dtd.$block[g];
                    ...
                    var e, k;
                    if (f) for (; (e = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[e.getName()]) && (!k || !k[g]);) e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    function a() {
                        var b = c.getDocument().$, d = b.getSelection(), g;
                        a:if (d.anchorNode && d.anchorNode == c.$) g = !0; else {
                    ...
                    function b() {
                        var a = c.getDocument().$, d = a.selection, g = c.getDocument().getActive();
                        "None" == d.type && g.equals(c) && (d = new CKEDITOR.dom.range(c), a = a.body.createTextRange(), d.moveToElementEditStart(c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT && (d = d.getParent()), a.moveToElementText(d.$), a.collapse(!0), a.select())
                    }
                    ...
                    var c = z, d = {range: a, doc: a.document}, g = this.getHtmlFromRange(a);
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                                var d = c.block.getElementsByTag("span"), f = 0, e;
                                if (d) for (; e = d.getItem(f++);) if (!n(e)) {
                                    d = !0;
                                    break a
                                }
                                d = !1
                    ...
                    if (!this.is("textarea")) {
                        ...
                        e && (f = d.getHead(), f.getCustomData("stylesheet") || (e = d.appendStyleText(e), e = new CKEDITOR.dom.element(e.ownerNode || e.owningElement), f.setCustomData("stylesheet", e), e.data("cke-temp", 1)));
                        f = d.getCustomData("stylesheet_ref") || 0;
                        d.setCustomData("stylesheet_ref", f + 1);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in h) {
                                b = a.getSelection();
                                var f, e = b.getRanges()[0], k = e.startPath(), l, D, u, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = m(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove(), e.select(), a.fire("saveSnapshot"), d = 1) : e.collapsed && ((l = k.block) && (u = l[c ? "getPrevious" : "getNext"](g)) && u.type == CKEDITOR.NODE_ELEMENT && u.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"), e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && l.remove(), e["moveToElementEdit" + (c ? "End" : "Start")](u), e.select(), a.fire("saveSnapshot"), d = 1) : k.blockLimit && k.blockLimit.is("td") && (D = k.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(D, c ? CKEDITOR.START : CKEDITOR.END) && (u = D[c ? "getPrevious" : "getNext"](g)) ? (a.fire("saveSnapshot"), e["moveToElementEdit" + (c ? "End" : "Start")](u), e.checkStartOfBlock() && e.checkEndOfBlock() ? u.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (D = k.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(D, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in h) {
                                ...
                                if (d.collapsed) a:{
                                    var g = b.block;
                                    if (g && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(g, !c) && d.collapsed) {
                                        ...
                                        d = d.startPath().block;
                                        if (!d || d && d.contains(g)) b = void 0; else {
                                            a.fire("saveSnapshot");
                                            var e;
                                ...
                                } else c = d, e = b.block, d = c.endPath().block, e && d && !e.equals(d) ? (a.fire("saveSnapshot"), (g = e.getBogus()) && g.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(e, !1), b.lastElement.mergeSiblings(), k(e, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        var g = CKEDITOR.dom.walker.whitespaces(!0), n = CKEDITOR.dom.walker.bookmark(!1, !0),
            t = CKEDITOR.dom.walker.empty(), r = CKEDITOR.dom.walker.bogus(),
            ...
            v = function () {
                ...
                function b(c, d) {
                    var g, f, e, k, h = [], l = d.range.startContainer;
                    g = d.range.startPath();
                    for (var l = m[l.getName()], n = 0, w = c.getChildren(), p = w.count(), q = -1, y = -1, v = 0, E = g.contains(m.$list); n < p; ++n) g = w.getItem(n), a(g) ? (e = g.getName(), E && e in CKEDITOR.dtd.$list ? h = h.concat(b(g, d)) : (k = !!l[e], "br" != e || !g.data("cke-eol") || n && n != p - 1 || (v = (f = n ? h[n - 1].node : w.getItem(n + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && m.$block[f.getName()]), -1 != q || k || (q = n), k || (y = n), h.push({
                        isElement: 1,
                        isLineBreak: v,
                        ...
                        name: e,
                        allowed: k
                    }), f = v = 0)) : h.push({isElement: 0, node: g, allowed: 1});
                    -1 < q && (h[q].firstNotAllowed = 1);
                    -1 < y && (h[y].lastNotAllowed = 1);
                    return h
                }

                function d(b, c) {
                    var g = [], f = b.getChildren(), e = f.count(), k, h = 0, l = m[c],
                        u = !b.is(m.$inline) || b.is("br");
                    for (u && g.push(" "); h < e; h++) k = f.getItem(h), a(k) && !k.is(l) ? g = g.concat(d(k, c)) : g.push(k);
                    u && g.push(" ");
                    return g
                }
                ...
                function k(b, c, d, g) {
                    ...
                    (e = (new CKEDITOR.dom.walker(f)).next()) && a(e) && n[e.getName()] && (h = e.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && d.contains(h) && g.contains(e) && e.isIdentical(h) && (e.moveChildren(h), e.remove(), k(b, c, d, g))
                }
                ...
                function h(b, c) {
                    ...
                    var g = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset - 1);
                    g && d(g, b[b.length - 1]);
                    f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse())
                }

                var m = CKEDITOR.dtd, n = {
                        p: 1,
                        div: 1,
                        h1: 1,
                        h2: 1,
                    ...
                    p = CKEDITOR.tools.extend({}, m.$inline);
                delete p.br;
                return function (n, D, q, v) {
                    var r = n.editor, z = !1;
                    "unfiltered_html" == D && (D = "html", z = !0);
                    if (!v.checkReadOnly()) {
                        var t = (new CKEDITOR.dom.elementPath(v.startContainer, v.root)).blockLimit || v.root;
                        n = {
                            type: D,
                            dontFilter: z,
                            editable: n,
                        ...
                        v = n.mergeCandidates;
                        var F, M;
                        "text" == n.type && D.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (F = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", D.document), D.insertNode(F), D.setStartAfter(F));
                        z = new CKEDITOR.dom.elementPath(D.startContainer);
                        n.endPath = t = new CKEDITOR.dom.elementPath(D.endContainer);
                        if (!D.collapsed) {
                            var r = t.block || t.blockLimit, W = D.getCommonAncestor();
                            r && !r.equals(W) && !r.contains(W) && D.checkEndOfBlock() && n.zombies.push(r);
                            D.deleteContents()
                        }
                        for (; (M = g(D)) && a(M) && M.isBlockBoundary() && z.contains(M);) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                        k(D, n.blockLimit, z, t);
                        F && (D.setEndBefore(F), D.collapse(), F.remove());
                        F = D.startPath();
                        if (r = F.contains(e, !1, 1)) D.splitElement(r), n.inlineStylesRoot = r, n.inlineStylesPeak = F.lastElement;
                        F = D.createBookmark();
                        (r = F.startNode.getPrevious(c)) && a(r) && e(r) && v.push(r);
                        (r = F.startNode.getNext(c)) && a(r) && e(r) && v.push(r);
                        for (r = F.startNode; (r = r.getParent()) && e(r);) v.push(r);
                        D.moveToBookmark(F);
                        if (F = q) {
                            F = n.range;
                            if ("text" == n.type && n.inlineStylesRoot) {
                                M = n.inlineStylesPeak;
                                D = M.getDocument().createText("{cke-peak}");
                                for (v = n.inlineStylesRoot.getParent(); !M.equals(v);) D = D.appendTo(M.clone()), M = M.getParent();
                                q = D.getOuterHtml().split("{cke-peak}").join(q)
                            }
                            M = n.blockLimit.getName();
                            ...
                            M = F.document.createElement("body");
                            M.setHtml(q);
                            U && (M.getFirst().remove(), M.getLast().remove());
                            if ((U = F.startPath().block) && (1 != U.getChildCount() || !U.getBogus())) a:{
                                var J;
                                if (1 == M.getChildCount() && a(J = M.getFirst()) && J.is(w) && !J.hasAttribute("contenteditable")) {
                                    U = J.getElementsByTag("*");
                                    F = 0;
                                    for (v = U.count(); F < v; F++) if (D = U.getItem(F), !D.is(p)) break a;
                        ...
                        if (F) {
                            ...
                            var V, da;
                            D = J.startContainer;
                            var z = n.endPath.elements[0], ba, t = z.getPosition(D),
                                W = !!z.getCommonAncestor(D) && t != CKEDITOR.POSITION_IDENTICAL && !(t & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                            D = b(n.dataWrapper, n);
                            for (h(D, J); v < D.length; v++) {
                                t = D[v];
                                if (L = t.isLineBreak) {
                                    L = J;
                                    V = M;
                                    var X = void 0, ea = void 0;
                                    t.hasBlockSibling ? L = 1 : (X = L.startContainer.getAscendant(m.$block, 1)) && X.is({
                                        div: 1,
                                        p: 1
                                    }) ? (ea = X.getPosition(V), ea == CKEDITOR.POSITION_IDENTICAL || ea == CKEDITOR.POSITION_CONTAINS ? L = 0 : (V = L.splitElement(X), L.moveToPosition(V, CKEDITOR.POSITION_AFTER_START), L = 1)) : L = 0
                                }
                                if (L) q = 0 < v; else {
                                    L = J.startPath();
                                    !t.isBlock && l(n.editor, L.block, L.blockLimit) && (aa = f(n.editor)) && (aa = F.createElement(aa), aa.appendBogus(), J.insertNode(aa), CKEDITOR.env.needsBrFiller && (S = aa.getBogus()) && S.remove(), J.moveToPosition(aa, CKEDITOR.POSITION_BEFORE_END));
                                    if ((L = J.startPath().block) && !L.equals(Q)) {
                                        if (S = L.getBogus()) S.remove(), U.push(L);
                                        Q = L
                                    }
                                    t.firstNotAllowed && (r = 1);
                                    if (r && t.isElement) {
                                        L = J.startContainer;
                                        for (V = null; L && !m[L.getName()][t.name];) {
                                            if (L.equals(M)) {
                                                L = null;
                                                break
                                            }
                                        ...
                                        if (L) V && (da = J.splitElement(V), n.zombies.push(da), n.zombies.push(V)); else {
                                            V = M.getName();
                                            ba = !v;
                                            L = v == D.length - 1;
                                            V = d(t.node, V);
                                            for (var X = [], ea = V.length, ca = 0, ga = void 0, fa = 0, ia = -1; ca < ea; ca++) ga = V[ca], " " == ga ? (fa || ba && !ca || (X.push(new CKEDITOR.dom.text(" ")), ia = X.length), fa = 1) : (X.push(ga), fa = 0);
                                            L && ia == X.length && X.pop();
                                            ba = X
                                        }
                                    }
                                    if (ba) {
                                        for (; L = ba.pop();) J.insertNode(L);
                                        ba = 0
                                    } else J.insertNode(t.node);
                                    t.lastNotAllowed && v < D.length - 1 && ((da = W ? z : da) && J.setEndAt(da, CKEDITOR.POSITION_AFTER_START), r = 0);
                                    J.collapse()
                                }
                            }
                            1 != D.length ? S = !1 : (S = D[0], S = S.isElement && "false" == S.node.getAttribute("contenteditable"));
                            S && (q = !0, L = D[0].node, J.setStartAt(L, CKEDITOR.POSITION_BEFORE_START), J.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
                            n.dontMoveCaret = q;
                        ...
                        for (ba = S.createBookmark(); Q = n.zombies.pop();) Q.getParent() && (aa = S.clone(), aa.moveToElementEditStart(Q), aa.removeEmptyBlocksAtEnd());
                        ...
                        if (!n.dontMoveCaret) {
                            for (Q = g(S); Q && a(Q) && !Q.is(m.$empty);) {
                                if (Q.isBlockBoundary()) S.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END); else {
                                    ...
                                    Z = S.clone();
                                    Z.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END)
                                }
                                Q = Q.getLast(c)
                            }
                            Z && S.moveToRange(Z)
                ...
                return function (d) {
                    var g = d.startContainer, f = g.getAscendant("table", 1), e = !1;
                ...
                eol: {
                    detect: function (a, b) {
                        var c = a.range, d = c.clone(), g = c.clone(),
                    ...
                    rebuild: function (a, b) {
                        var c = a.range, d = c.getCommonAncestor(), g = new CKEDITOR.dom.elementPath(d, b),
                            f = new CKEDITOR.dom.elementPath(c.startContainer, b),
                            c = new CKEDITOR.dom.elementPath(c.endContainer, b), e;
                        d.type == CKEDITOR.NODE_TEXT && (d = d.getParent());
                        if (g.blockLimit.is({tr: 1, table: 1})) {
                            var k = g.contains("table").getParent();
                            e = function (a) {
                                return !a.equals(k)
                            }
                            ...
                            var h = g.contains(CKEDITOR.dtd.$list).getParent();
                            e = function (a) {
                                return !a.equals(h)
                            }
                        }
                        ...
                        for (var g; c && !c.equals(b) && d(c);) g = c.clone(0, 1), a.fragment.appendTo(g), a.fragment = g, c = c.getParent()
                    }
                }, cell: {
                    shrink: function (a) {
                        a = a.range;
                        var b = a.startContainer, c = a.endContainer, d = a.startOffset, g = a.endOffset;
                ...
                return {
                    list: {
                        detectMerge: function (a, b) {
                            var d = c(b, a.bookmark), g = d.startPath(), f = d.endPath(),
                                e = g.contains(CKEDITOR.dtd.$list), k = f.contains(CKEDITOR.dtd.$list);
                            a.mergeList = e && k && e.getParent().equals(k.getParent()) && !e.equals(k);
                            ...
                            if (a.mergeListBookmark) {
                                var d = a.mergeListBookmark.startNode, g = a.mergeListBookmark.endNode,
                                    f = new CKEDITOR.dom.elementPath(d, c), e = new CKEDITOR.dom.elementPath(g, c);
                                if (a.mergeList) {
                                    var k = f.contains(CKEDITOR.dtd.$list), h = e.contains(CKEDITOR.dtd.$list);
                        ...
                        detectMerge: function (a, b) {
                            ...
                            if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                                var d = a.mergeBlockBookmark.startNode, g = a.mergeBlockBookmark.endNode,
                                    f = new CKEDITOR.dom.elementPath(d, c), e = new CKEDITOR.dom.elementPath(g, c),
                                    f = f.block, e = e.block;
                                f && e && !f.equals(e) && b(e, d, g);
                                d.remove();
                                g.remove()
                            }
                        }
                        ...
                        function a(c) {
                            var g = [], f, e = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d),
                                h = c.endPath().contains(d), m = {};
                            e.guard = function (a, e) {
                                ...
                                if (e && k && a.equals(k)) f = c.clone(), f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), g.push(f); else if (!e && h && a.equals(h)) f = c.clone(), f.setStartAt(h, CKEDITOR.POSITION_AFTER_START), g.push(f); else {
                                    if (l = !e) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
                        ...
                        function b(a, c) {
                            var d = CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED, g = a.getPosition(c);
                        ...
                        return {
                            detectPurge: function (a) {
                                ...
                                var c = new CKEDITOR.dom.walker(c), g = 0;
                                ...
                                var e = c(f, g.bookmark), k = e.clone(), h, m, l = e.getCommonAncestor();
                                l.is(CKEDITOR.dtd.$tableContent) && !l.is(d) && (l = l.getAscendant("table", !0));
                                m = l;
                                l = new CKEDITOR.dom.elementPath(e.startContainer, m);
                                m = new CKEDITOR.dom.elementPath(e.endContainer, m);
                                l = l.contains("table");
                                m = m.contains("table");
                                if (l || m) l && m && b(l, m) ? (g.tableSurroundingRange = k, k.setStartAt(l, CKEDITOR.POSITION_AFTER_END), k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), k = e.clone(), k.setEndAt(l, CKEDITOR.POSITION_AFTER_END), h = e.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START), h = a(k).concat(a(h))) : l ? m || (g.tableSurroundingRange = k, k.setStartAt(l, CKEDITOR.POSITION_AFTER_END), e.setEndAt(l, CKEDITOR.POSITION_AFTER_END)) : (g.tableSurroundingRange = k, k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), e.setStartAt(m, CKEDITOR.POSITION_AFTER_START)), g.tableContentsRanges = h ? h : a(e)
                        ...
                        var c = b.startPath(), d;
                        l(a, c.block, c.blockLimit) && (d = f(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
                    }
                }
            }()
    }(),function () {
        ...
        function e() {
            t = !0;
            n || (b.call(this), n = CKEDITOR.tools.setTimeout(b, 200, this))
        }

        function b() {
            n = null;
            t && (CKEDITOR.tools.setTimeout(a, 0, this), t = !1)
        }
        ...
        function d(a) {
            ...
            var d = a.startContainer, g = a.getPreviousNode(c, null, d), f = a.getNextNode(c, null, d);
            return b(g) || b(f, 1) || !(g || f || d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() && d.getBogus()) ? !0 : !1
        }
        ...
        function l(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), g = d && "None" != d.type && d.getRangeAt(0),
                        e = z.length;
                    if (c.getLength() > e && g && g.intersectsNode(c.$)) {
                        ...
                        d.anchorNode == c.$ && d.anchorOffset > e && (k[0].offset -= e);
                        d.focusNode == c.$ && d.focusOffset > e && (k[1].offset -= e)
                    }
                }
        ...
        function h(a) {
            var b = CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie ? "display:none" : "position:fixed;top:0;left:-1000px") + '"\x3e\x26nbsp;\x3c/div\x3e', a.document);
            a.fire("lockSnapshot");
            a.editable().append(b);
            var c = a.getSelection(1), d = a.createRange(), g = c.root.on("selectionchange", function (a) {
                a.cancel()
            }, null, null, 0);
        ...
        function k(a) {
            ...
            return function (c) {
                ...
                if (b[d]) {
                    var g = a.getSelection().getRanges(), f = g[0];
        ...
        function g(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly()) for (var d = c.startContainer, g; d && !((g = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly());) g && "false" == d.getAttribute("contentEditable") && c.setStartAfter(d), d = d.getParent();
                    d = c.startContainer;
                    g = c.endContainer;
                    var f = c.startOffset, e = c.endOffset, k = c.clone();
                    d && d.type == CKEDITOR.NODE_TEXT && (f >= d.getLength() ? k.setStartAfter(d) : k.setStartBefore(d));
                    g && g.type == CKEDITOR.NODE_TEXT && (e ? k.setEndAfter(g) : k.setEndBefore(g));
                    ...
                    d.evaluator = function (d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                            ...
                            d.getPosition(k.endContainer) & CKEDITOR.POSITION_CONTAINS || (g.setStartAfter(d), g.collapsed || a.splice(b + 1, 0, g));
                            return !0
                        }
                        return !1
                    };
        ...
        var n, t, r = CKEDITOR.dom.walker.invisible(1), q = function () {
            function a(b) {
                return function (a) {
            ...
            function b(a) {
                return function (b) {
                    var c = b.editor, d = c.createRange(), g;
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                function b() {
                    w = new CKEDITOR.dom.selection(d.getSelection());
                    w.lock()
                }
                ...
                var g = d.document, f = CKEDITOR.document, h = d.editable(), m = g.getBody(),
                    n = g.getDocumentElement(), u = h.isInline(), D, w;
                CKEDITOR.env.gecko && h.attachListener(h, "focus", function (a) {
                    a.removeListener();
                    0 !== D && (a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = d.createRange(), a.moveToElementEditStart(h), a.select())
                }, null, null, -2);
                h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    D && CKEDITOR.env.webkit && (D = d._.previousActive && d._.previousActive.equals(g.getActive()));
                    d.unlockSelection(D);
                    D = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || u) v ? h.attachListener(h, "beforedeactivate", b, null, null, -1) : h.attachListener(d, "selectionCheck", b, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    d.lockSelection(w);
                    D = 1
                ...
                if (CKEDITOR.env.ie && !u) {
                    ...
                    h.attachListener(h, "mousedown", function (a) {
                        2 == a.data.$.button && ((a = d.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (q = d.window.getScrollPosition()))
                    });
                    h.attachListener(h, "mouseup", function (a) {
                        2 == a.data.$.button && q && (d.document.$.documentElement.scrollLeft = q.x, d.document.$.documentElement.scrollTop = q.y);
                        q = null
                    });
                    if ("BackCompat" != g.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) n.on("mousedown", function (a) {
                            function b(a) {
                                ...
                                if (d) {
                                    ...
                                    d.setEndPoint(0 > e.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                    d.select()
                                }
                            }
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) n.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (f.on("mouseup", c), n.on("mouseup", c))
                        })
                    }
                }
        ...
        var v = "function" != typeof window.getSelection, p = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            a = this.getNative();
            var d, g;
            if (a) if (a.getRangeAt) d = (g = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(g.commonAncestorContainer); else {
                try {
                    g = a.createRange()
                } catch (f) {
                }
        ...
        var w = {
            ...
            thead: 1,
            tfoot: 1
        }, z = CKEDITOR.tools.repeat("​", 7), B = new RegExp(z + "( )?", "g");
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                    ...
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && w[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                }
                return a.type = b
            }, getRanges: function () {
                var a = v ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var g = d.children, f, e, h = b.duplicate(), k = 0, m = g.length - 1, l = -1, n, w; k <= m;) if (l = Math.floor((k + m) / 2), f = g[l], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) m = l - 1; else if (0 > n) k = l + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == l || l == g.length - 1 && 0 > n) {
                            ...
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            g = d.childNodes;
                            if (!h) return f = g[g.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? {
                                container: d,
                                offset: g.length
                            } : {container: f, offset: f.nodeValue.length};
                            for (d = g.length; 0 < h && 0 < d;) e = g[--d], e.nodeType == CKEDITOR.NODE_TEXT && (w = e, h -= e.nodeValue.length);
                            return {container: w, offset: -h}
                        }
                        h.collapse(0 < n ? !0 : !1);
                        ...
                        for (; 0 < h;) try {
                            e = f[0 < n ? "previousSibling" : "nextSibling"], e.nodeType == CKEDITOR.NODE_TEXT && (h -= e.nodeValue.length, w = e), f = e
                        } catch (q) {
                            return {container: d, offset: a(f)}
                        }
                        return {container: w, offset: 0 < n ? -h : w.nodeValue.length + h}
                    };
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], g = 0; g < c.length; g++) {
                                for (var f = c.item(g), e = f.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h < e.childNodes.length && e.childNodes[h] != f; h++) ;
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d, g = 2; g && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && w[c.getName()] && (d = c)); g--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
                ...
                var b = this.getNative(), b = v ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                this.reset();
                if (b) for (var b = this.root, c, g = 0; g < a.length; ++g) c = a[g], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount()));
                if (a.length) if (this.isLocked) {
                    ...
                    a:{
                        var h, k;
                        if (1 == a.length && !(k = a[0]).collapsed && (e = k.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && (k = k.clone(), k.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (h = k.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (e = h), "false" == e.getAttribute("contenteditable"))) break a;
                        e = void 0
                    }
                    if (e) this.fake(e); else {
                        if (v) {
                            ...
                            1 < a.length && (e = a[a.length - 1], a[0].setEnd(e.endContainer, e.endOffset));
                            e = a[0];
                            a = e.collapsed;
                            var n, q, p;
                            if ((c = e.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in w && (!c.is("a") || !c.getText())) try {
                            ...
                            if (e.startContainer.type == CKEDITOR.NODE_ELEMENT && e.startContainer.getName() in b || e.endContainer.type == CKEDITOR.NODE_ELEMENT && e.endContainer.getName() in b) e.shrink(CKEDITOR.NODE_ELEMENT, !0), a = e.collapsed;
                            p = e.createBookmark();
                            b = p.startNode;
                            a || (f = p.endNode);
                            p = e.document.$.body.createTextRange();
                            p.moveToElementText(b.$);
                            p.moveStart("character", 1);
                            f ? (h = e.document.$.body.createTextRange(), h.moveToElementText(f.$), p.setEndPoint("EndToEnd", h), p.moveEnd("character", -1)) : (n = b.getNext(k), q = b.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(h)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), q = e.document.createElement("span"), q.setHtml("\x26#65279;"), q.insertBefore(b), n && e.document.createText("﻿").insertBefore(b));
                            e.setStartBefore(b);
                            b.remove();
                            a ? (n ? (p.moveStart("character", -1), p.select(), e.document.$.selection.clear()) : p.select(), e.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START), q.remove()) : (e.setEndBefore(f), f.remove(), p.select())
                        } else {
                            f = this.getNative();
                            if (!f) return;
                            this.removeAllRanges();
                            for (p = 0; p < a.length; p++) {
                                if (p < a.length - 1 && (n = a[p], q = a[p + 1], h = n.clone(), h.setStart(n.endContainer, n.endOffset), h.setEnd(q.startContainer, q.startOffset), !h.collapsed && (h.shrink(CKEDITOR.NODE_ELEMENT, !0), e = h.getCommonAncestor(), h = h.getEnclosedNode(), e.isReadOnly() || h && h.isReadOnly()))) {
                                ...
                                e.collapsed && CKEDITOR.env.webkit && d(e) && (h = m(this.root), e.insertNode(h), (n = h.getNext()) && !h.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (l(this.root), e.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END));
                                q.setStart(e.startContainer.$, e.startOffset);
                                try {
                                    q.setEnd(e.endContainer.$, e.endOffset)
                                } catch (r) {
                                    if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) e.collapse(1), q.setEnd(e.endContainer.$, e.endOffset); else throw r;
                                }
                                f.addRange(q)
                            }
                        }
        ...
        function b(c) {
            var g = c.document;
            if (c.collapsed) g = w(this, g), c.insertNode(g), c.moveToPosition(g, CKEDITOR.POSITION_BEFORE_END); else {
                var f = this.element, h = this._.definition, k, m = h.ignoreReadonly, l = m || h.includeReadonly;
                ...
                c.trim();
                var p = c.createBookmark(), v = p.startNode, r = p.endNode, z = v, u;
                if (!m) {
                    var t = c.getCommonAncestor(), m = a(v, t), t = a(r, t);
                    m && (z = m.getNextSourceNode(!0));
                    t && (r = t)
                }
                for (z.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (z = 0); z;) {
                    m = !1;
                    if (z.equals(r)) z = null, m = !0; else {
                        var B = z.type == CKEDITOR.NODE_ELEMENT ? z.getName() : null,
                            t = B && "false" == z.getAttribute("contentEditable"),
                            y = B && z.getAttribute("data-nostyle");
                        if (B && z.data("cke-bookmark")) {
                            z = z.getNextSourceNode(!0);
                            continue
                        }
                        if (t && l && CKEDITOR.dtd.$block[B]) for (var E = z, x = d(E), A = void 0, C = x.length, G = 0, E = C && new CKEDITOR.dom.range(E.getDocument()); G < C; ++G) {
                            var A = x[G], ga = CKEDITOR.filter.instances[A.data("cke-filter")];
                            if (ga ? ga.check(this) : 1) E.selectNodeContents(A), b.call(this, E)
                        }
                        x = B ? !n[B] || y ? 0 : t && !l ? 0 : e(z, r, h, H) : 1;
                        if (x) if (A = z.getParent(), x = h, C = f, G = k, !A || !(A.getDtd() || CKEDITOR.dtd.span)[C] && !G || x.parentRule && !x.parentRule(A)) m = !0; else {
                            if (u || B && CKEDITOR.dtd.$removeEmpty[B] && (z.getPosition(r) | H) != H || (u = c.clone(), u.setStartBefore(z)), B = z.type, B == CKEDITOR.NODE_TEXT || t || B == CKEDITOR.NODE_ELEMENT && !z.getChildCount()) {
                                for (var B = z, fa; (m = !B.getNext(F)) && (fa = B.getParent(), n[fa.getName()]) && e(fa, v, h, K);) B = fa;
                                u.setEndAfter(B)
                            }
                        } else m = !0;
                        z = z.getNextSourceNode(y || t)
                    }
                    if (m && u && !u.collapsed) {
                        for (var m = w(this, g), t = m.hasAttributes(), y = u.getCommonAncestor(), B = {}, x = {}, A = {}, C = {}, I, Z, ha; m && y;) {
                            if (y.getName() == f) {
                                for (I in h.attributes) !C[I] && (ha = y.getAttribute(Z)) && (m.getAttribute(I) == ha ? x[I] = 1 : C[I] = 1);
                                for (Z in h.styles) !A[Z] && (ha = y.getStyle(Z)) && (m.getStyle(Z) == ha ? B[Z] = 1 : A[Z] = 1)
                            }
                            y = y.getParent()
                        }
                        for (I in x) m.removeAttribute(I);
                        for (Z in B) m.removeStyle(Z);
                        t && !m.hasAttributes() && (m = null);
                        m ? (u.extractContents().appendTo(m), u.insertNode(m), q.call(this, m), m.mergeSiblings(), CKEDITOR.env.ie || m.$.normalize()) : (m = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(m), u.insertNode(m), q.call(this, m), m.remove(!0));
                        u = null
                    }
                }
                c.moveToBookmark(p);
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), g = null, f = null, e = 0; e < a.elements.length; e++) {
                    var h = a.elements[e];
                ...
                for (e = 0; e < c.elements.length; e++) {
                    ...
                    l.checkElementRemovable(h, !0) && (f = h)
                }
                f && m.breakParent(f);
                g && d.breakParent(g)
            }
            ...
            if (a.collapsed) {
                for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, e = 0, h; e < g.elements.length && (h = g.elements[e]) && h != g.block && h != g.blockLimit; e++) if (this.checkElementRemovable(h)) {
                    var k;
                    a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (k = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (f = h, f.match = k ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? r.call(this, h) : v(h, u(this)[h.getName()]))
                }
                if (f) {
                    h = d;
                    for (e = 0; ; e++) {
                ...
                var m = c.endNode, l = this;
                b();
                for (g = d; !g.equals(m);) f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? r.call(this, g) : v(g, u(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), g = f
            }
            a.moveToBookmark(c);
        ...
        function l(a) {
            ...
            if (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) {
                ...
                if (b.styles) for (var g in b.styles) b.styles.hasOwnProperty(g) && a.removeStyle(g)
            }
        }
        ...
        function f(a) {
            ...
            for (var d, g = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = w(this, g, d), k(d, f));
            a.moveToBookmark(b)
        }
        ...
        function h(a) {
            ...
            for (var d, g; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((g = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(g), k(d, g)) : r.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function k(a, b) {
            ...
            var d = b && b.is("pre"), f = a.is("pre"), e = !d && f;
            if (d && !f) {
                f = b;
                ...
                b = f
            } else e ? b = t(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
                (k = c.getPrevious(I)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = n(k.getHtml(), /\n$/, "") + "\n\n" + n(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" : c.setHtml(d), k.remove())
            } else c && p(b)
        }
        ...
        function r(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, g = u(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), e;
            for (e in d) if ("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == y(e, d[e])) b && "data-" == e.slice(0, 5) || (f = a.hasAttribute(e), a.removeAttribute(e));
            for (var h in c) this._.definition.fullMatch && a.getStyle(h) != y(h, c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
            v(a, g, x[a.getName()]);
            f && (this._.definition.alwaysRemoveElement ? p(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? p(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        }

        function q(a) {
            for (var b = u(this), c = a.getElementsByTag(this.element), d, g = c.count(); 0 <= --g;) d = c.getItem(g), d.isReadOnly() || r.call(this, d, !0);
            for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), g = c.count() - 1; 0 <= g; g--) d = c.getItem(g), d.isReadOnly() || v(d, b[f])
        }
        ...
        function p(a, b) {
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(I), d = a.getNext(I);
        ...
        function z(a, b) {
            ...
            if (d) for (var g in d) a.setAttribute(g, d[g]);
        ...
        function u(a) {
            ...
            if (c) {
                ...
                for (var d = 0; d < c.length; d++) {
                    ...
                    g = b[f] || (b[f] = {});
                    if (e) {
                        var g = g.attributes = g.attributes || [], h;
                        for (h in e) g.push([h.toLowerCase(), e[h]])
                    }
                }
            }
            return b
        ...
        function E(a, b, c) {
            var d = a.document, g = a.getRanges();
            b = b ? this.removeFromRange : this.applyToRange;
            for (var f, e = g.createIterator(); f = e.getNextRange();) b.call(this, f, c);
            a.selectRanges(g);
        ...
        var x = {
                ...
                audio: 1,
                video: 1
            }, C = /\s*(?:;\s*|$)/, G = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1),
        ...
        CKEDITOR.style = function (a, b) {
            ...
            this.type = a.type || (x[c] ? CKEDITOR.STYLE_BLOCK : A[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
            "object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT);
            this._ = {definition: a}
        };
        CKEDITOR.style.prototype = {
            apply: function (a) {
                if (a instanceof CKEDITOR.dom.document) return E.call(this, a.getSelection());
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
                    E.call(this, a.getSelection(), 0, a);
                    this._.enterMode = b
                }
            }, remove: function (a) {
                if (a instanceof CKEDITOR.dom.document) return E.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
                    E.call(this, a.getSelection(), 1, a);
                    this._.enterMode = b
                }
            }, applyToRange: function (a) {
                this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? f : this.type == CKEDITOR.STYLE_OBJECT ? m : null;
                ...
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c = a.elements, d = 0, g; d < c.length; d++) if (g = c[d], this.type != CKEDITOR.STYLE_INLINE || g != a.block && g != a.blockLimit) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (d = c._AC) c = d; else {
                        var d = {}, g = 0, f = c.attributes;
                        if (f) for (var e in f) g++, d[e] = f[e];
                    ...
                    if (c._length) {
                        for (var h in c) if ("_length" != h) {
                            ...
                            if ("style" == h) a:{
                                ...
                                "string" == typeof g && (g = CKEDITOR.tools.parseCssText(g, !0));
                                e = void 0;
                                for (e in d) if (!(e in g) || g[e] != d[e] && "inherit" != d[e] && "inherit" != g[e]) {
                                    d = !1;
                                    break a
                                }
                                d = !0
                ...
                "bdo" == d && (d = "span");
                var c = ["\x3c", d], g = b.attributes;
                if (g) for (var f in g) c.push(" ", f, '\x3d"', g[f], '"');
        ...
        var H = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED,
        ...
        CKEDITOR.dom.elementPath = function (b, d) {
            ...
            do if (h.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (h.equals(d)) break;
                if (!l && (k = h.getName(), "true" == h.getAttribute("contenteditable") ? l = h : !m && e[k] && (m = h), a[k])) {
                    if (k = !m && "div" == k) {
                        a:{
                            k = h.getChildren();
        ...
        compare: function (a) {
            ...
            var d = this.elements, m = d.length;
            e && m--;
            b && (d = Array.prototype.slice.call(d, 0), d.reverse());
            for (e = 0; e < m; e++) if (c(d[e])) return d[e];
            return null
        ...
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), d = this.getDocument(),
                m = new CKEDITOR.dom.text(this.$.splitText(a), d);
            e.childNodes.length == b && (a >= c ? (m = d.createText(""), m.insertAfter(this)) : (a = d.createText(""), a.insertAfter(m), a.remove()));
            return m
        ...
        function a(a, c, d) {
            var e = a.serializable, l = c[d ? "endContainer" : "startContainer"], f = d ? "endOffset" : "startOffset",
                h = e ? c.document.getById(a.startNode) : a.startNode;
            a = e ? c.document.getById(a.endNode) : a.endNode;
            l.equals(h.getPrevious()) ? (c.startOffset = c.startOffset - l.getLength() - a.getPrevious().getLength(), l = a.getNext()) : l.equals(a.getPrevious()) && (c.startOffset -= l.getLength(), l = a.getNext());
            l.equals(h.getParent()) && c[f]++;
            l.equals(a.getParent()) && c[f]++;
                ...
                return {
                    getNextRange: function (l) {
                        ...
                        if (f && 1 < a.length) {
                            ...
                            if (l) for (var k = 0; a[e + k + 1];) {
                                var g = f.document;
                                l = 0;
                                h = g.getById(d[k].endNode);
                                for (g = g.getById(d[k + 1].startNode); ;) {
                                    h = h.getNextSourceNode(!1);
                                    if (g.equals(h)) l = 1; else if (c(h) || h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) continue;
                                    break
                                }
                                if (!l) break;
                                k++
        ...
        function e(b) {
            ...
            if (c) for (var c = c.split(",").sort(function (a, b) {
                return a > b ? -1 : 1
            }), f = 0, e; f < c.length; f++) if (e = c[f], d.ie && (e.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == e) && (e = "ie"), d[e]) {
                b += "_" + c[f];
                break
            }
        ...
        function b(a, b) {
            m[a] || (CKEDITOR.document.appendStyleSheet(e(a)), m[a] = 1);
            b && b()
        }
        ...
        var l = "cke_ui_color", f = [], h = /\$color/g;
        ...
        return function (c, d) {
            var m = c.uiColor, m = {
                id: "." + c.id,
                defaultBorder: a(m, -.1),
                defaultGradient: e(a(m, .9), m),
                lightGradient: e(a(m, 1), a(m, .7)),
                mediumGradient: e(a(m, .8), a(m, .5)),
                ckeButtonOn: e(a(m, .6), a(m, .7)),
                ckeResizer: a(m, -.4),
                ckeToolbarSeparator: a(m, .5),
                ckeColorauto: a(m, .8),
                dialogBody: a(m, .7),
                dialogTabSelected: e("#FFFFFF", "#FFFFFF"),
                dialogTabSelectedBorder: "#FFF",
                elementsPathColor: a(m, -.6),
                elementsPathBg: m,
                menubuttonIcon: a(m, .5),
                menubuttonIconHover: a(m, .3)
            };
            return b[d].output(m).replace(/\[/g, "{").replace(/\]/g, "}")
        }
        ...
        onLoad: function () {
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                labeledElement: function (b, c, d, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        this._.children = [];
                        var m = {role: c.role || "presentation"};
                        c.includeLabel && (m["aria-labelledby"] = e.labelId);
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "div", null, m, function () {
                            var a = [], d = c.required ? " cke_required" : "";
                            "horizontal" != c.labelLayout ? a.push('\x3clabel class\x3d"cke_dialog_ui_labeled_label' + d + '" ', ' id\x3d"' + e.labelId + '"', e.inputId ? ' for\x3d"' + e.inputId + '"' : "", (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", c.label, "\x3c/label\x3e", '\x3cdiv class\x3d"cke_dialog_ui_labeled_content"', c.controlStyle ? ' style\x3d"' + c.controlStyle + '"' : "", ' role\x3d"presentation"\x3e', f.call(this, b, c), "\x3c/div\x3e") : (d = {
                                type: "hbox",
                                widths: c.widths,
                                padding: 0,
                                children: [{
                                    type: "html",
                                    html: '\x3clabel class\x3d"cke_dialog_ui_labeled_label' + d + '" id\x3d"' + e.labelId + '" for\x3d"' + e.inputId + '"' + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e" + CKEDITOR.tools.htmlEncode(c.label) + "\x3c/label\x3e"
                                }, {
                                    type: "html",
                                    html: '\x3cspan class\x3d"cke_dialog_ui_labeled_content"' + (c.controlStyle ? ' style\x3d"' + c.controlStyle + '"' : "") + "\x3e" + f.call(this, b, c) + "\x3c/span\x3e"
                                }]
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        var e = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput",
                            m = {"class": "cke_dialog_ui_input_" + c.type, id: e, type: c.type};
                        c.validate && (this.validate = c.validate);
                        c.maxLength && (m.maxlength = c.maxLength);
                        c.size && (m.size = c.size);
                        c.inputStyle && (m.style = c.inputStyle);
                        var l = this, q = !1;
                        b.on("load", function () {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            for (var b in m) a.push(b + '\x3d"' + m[b] + '" ');
                    ...
                    if (!(3 > arguments.length)) {
                        a.call(this, c);
                        var e = this, m = this._.inputId = CKEDITOR.tools.getNextId() + "_textarea", l = {};
                        c.validate && (this.validate = c.validate);
                        l.rows = c.rows || 5;
                        l.cols = c.cols || 20;
                        ...
                        c.dir && (l.dir = c.dir);
                        if (e.bidi) b.on("load", function () {
                            e.getInputElement().on("keyup", f)
                        }, e);
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            l["aria-labelledby"] = this._.labelId;
                            this._.required && (l["aria-required"] = this._.required);
                            var a = ['\x3cdiv class\x3d"cke_dialog_ui_input_textarea" role\x3d"presentation"\x3e\x3ctextarea id\x3d"', m, '" '],
                                b;
                    ...
                    if (!(3 > arguments.length)) {
                        var f = a.call(this, c, {"default": !!c["default"]});
                        c.validate && (this.validate = c.validate);
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "span", null, null, function () {
                            var a = CKEDITOR.tools.extend({}, c, {id: c.id ? c.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0),
                                d = [], g = CKEDITOR.tools.getNextId() + "_label",
                                e = {"class": "cke_dialog_ui_checkbox_input", type: "checkbox", "aria-labelledby": g};
                            l(a);
                            c["default"] && (e.checked = "checked");
                            "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                            f.checkbox = new CKEDITOR.ui.dialog.uiElement(b, a, d, "input", null, e);
                            d.push(' \x3clabel id\x3d"', g, '" for\x3d"', e.id, '"' + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", CKEDITOR.tools.htmlEncode(c.label), "\x3c/label\x3e");
                            return d.join("")
                        })
                    }
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", m = 0; m < c.items.length; m++) {
                                var w = c.items[m], z = void 0 !== w[2] ? w[2] : w[0],
                                    B = void 0 !== w[1] ? w[1] : w[0], u = CKEDITOR.tools.getNextId() + "_radio_input",
                                    y = u + "_label",
                                    u = CKEDITOR.tools.extend({}, c, {id: u, title: null, type: null}, !0),
                                    z = CKEDITOR.tools.extend({}, u, {title: z}, !0), E = {
                                        type: "radio",
                                ...
                                e._["default"] == B && (E.checked = "checked");
                                l(u);
                                l(z);
                                "undefined" != typeof u.inputStyle && (u.style = u.inputStyle);
                                u.keyboardFocusable = !0;
                                f.push(new CKEDITOR.ui.dialog.uiElement(b, u, x, "input", null, E));
                                x.push(" ");
                                new CKEDITOR.ui.dialog.uiElement(b, z, x, "label", null, {id: y, "for": E.id}, w[0]);
                                a.push(x.join(""))
                            }
                    ...
                    if (arguments.length) {
                        ...
                        delete e.style;
                        var m = CKEDITOR.tools.getNextId() + "_label";
                        CKEDITOR.ui.dialog.uiElement.call(this, b, e, d, "a", null, {
                            ...
                            role: "button",
                            "aria-labelledby": m
                        }, '\x3cspan id\x3d"' + m + '" class\x3d"cke_dialog_ui_button"\x3e' + CKEDITOR.tools.htmlEncode(c.label) + "\x3c/span\x3e")
                    }
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            l(a);
                            for (var m = 0, w; m < c.items.length && (w = c.items[m]); m++) g.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== w[1] ? w[1] : w[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(w[0]));
                            "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                            f.select = new CKEDITOR.ui.dialog.uiElement(b, a, d, "select", null, e, g.join(""));
                            d.push("\x3c/div\x3e");
                            return d.join("")
                        })
                    }
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        var f = CKEDITOR.tools.extend(a.call(this, c), {definition: c, buttons: []});
                        c.validate && (this.validate = c.validate);
                        b.on("load", function () {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            var a = ['\x3ciframe frameborder\x3d"0" allowtransparency\x3d"0" class\x3d"cke_dialog_ui_input_file" role\x3d"presentation" id\x3d"', f.frameId, '" title\x3d"', c.label, '" src\x3d"javascript:void('];
                    ...
                    if (!(3 > arguments.length)) {
                        a.call(this, c);
                        c.validate && (this.validate = c.validate);
                        var e = CKEDITOR.tools.extend({}, c), m = e.onClick;
                        e.className = (e.className ? e.className + " " : "") + "cke_dialog_ui_button";
                        e.onClick = function (a) {
                            var d = c["for"];
                            m && !1 === m.call(this, a) || (b.getContentElement(d[0], d[1]).submit(), this.disable())
                        };
                        b.on("load", function () {
                    ...
                    return function (d, f, e) {
                        if (!(3 > arguments.length)) {
                            ...
                            if (p) {
                                var w = this.focus;
                                this.focus = function () {
                                    ("function" == typeof p ? p : w).call(this);
                                    this.fire("focus")
                                };
                                f.isFocusable && (this.isFocusable = this.isFocusable);
                                this.keyboardFocusable = !0
                            }
                            CKEDITOR.ui.dialog.uiElement.call(this, d, f, m, "span", null, null, "");
                            m = m.join("").match(a);
                            l = l.match(b) || ["", "", ""];
                            c.test(l[1]) && (l[1] = l[1].slice(0, -1), l[2] = "/" + l[2]);
                            e.push([l[1], " ", m[1] || "", l[2]].join(""))
                        }
                    }
                    ...
                    CKEDITOR.ui.dialog.uiElement.call(this, a, f, d, "fieldset", null, null, function () {
                        var a = [];
                        e && a.push("\x3clegend" + (f.labelStyle ? ' style\x3d"' + f.labelStyle + '"' : "") + "\x3e" + e + "\x3c/legend\x3e");
            ...
            CKEDITOR.ui.dialog.select.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
                getInputElement: function () {
                    ...
                    void 0 === c || null === c ? CKEDITOR.env.ie ? f.add(d.$) : f.add(d.$, null) : f.add(d.$, c);
                    return this
                }, remove: function (a) {
            ...
            CKEDITOR.dialog.addUIElement("fieldset", {
                build: function (a, b, c) {
                    for (var d = b.children, f, e = [], m = [], l = 0; l < d.length && (f = d[l]); l++) {
                        var p = [];
                        e.push(p);
                        m.push(CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, p))
                    }
                    return new CKEDITOR.ui.dialog[b.type](a, m, e, c, b)
                }
            })
        }
        ...
        function m(a) {
            ...
            })), c = b.getChild([0, 0, 0, 0, 0]), d = c.getChild(0), g = c.getChild(1);
        ...
        function k(a) {
            function b(c) {
                var k = a.getSize(), m = CKEDITOR.document.getWindow().getViewPaneSize(), l = c.data.$.screenX,
                    n = c.data.$.screenY, p = l - d.x, w = n - d.y;
                d = {x: l, y: n};
                g.x += p;
                g.y += w;
                a.move(g.x + h[3] < e ? -h[3] : g.x - h[1] > m.width - k.width - e ? m.width - k.width + ("rtl" == f.lang.dir ? 0 : h[1]) : g.x, g.y + h[0] < e ? -h[0] : g.y - h[2] > m.height - k.height - e ? m.height - k.height + h[2] : g.y, 1);
            ...
            var d = null, g = null, f = a.getParentEditor(), e = f.config.dialog_magnetDistance,
            ...
            a.parts.title.on("mousedown", function (f) {
                ...
                g = a.getPosition();
                if (CKEDITOR.env.ie6Compat) {
                    var e = x.getChild(0).getFrameDocument();
                    e.on("mousemove", b);
                    e.on("mouseup", c)
                }
        ...
        function g(a) {
            function b(c) {
                var n = "rtl" == f.lang.dir, p = l.width, w = l.height,
                    q = p + (c.data.$.screenX - m.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
                    z = w + (c.data.$.screenY - m.y) * (a._.moved ? 1 : 2), u = a._.element.getFirst(),
                    u = n && u.getComputedStyle("right"), v = a.getPosition();
                v.y + z > k.height && (z = k.height - v.y);
                (n ? u : v.x) + q > k.width && (q = k.width - (n ? u : v.x));
                if (g == CKEDITOR.DIALOG_RESIZE_WIDTH || g == CKEDITOR.DIALOG_RESIZE_BOTH) p = Math.max(d.minWidth || 0, q - e);
                if (g == CKEDITOR.DIALOG_RESIZE_HEIGHT || g == CKEDITOR.DIALOG_RESIZE_BOTH) w = Math.max(d.minHeight || 0, z - h);
                a.resize(p, w);
                a._.moved || a.layout();
                c.data.preventDefault()
            }
            ...
            var d = a.definition, g = d.resizable;
            if (g != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(), e, h, k, m, l, n, p = CKEDITOR.tools.addFunction(function (d) {
                    l = a.getSize();
                    ...
                    e = l.width - a.parts.contents.getSize("width", 1);
                ...
                a.on("load", function () {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + p + ', event )"\x3e' + ("ltr" == f.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function t(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = c.dialog_backgroundCoverColor || "white",
                g = c.dialog_backgroundCoverOpacity, f = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d, g, f),
                e = E[c];
        ...
        CKEDITOR.dialog = function (b, f) {
            ...
            function l(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    var g = c, f = 1 < x._.pageCount;
                    do {
                        g += a;
                        if (f && !x._.tabBarMode && (g == b.length || -1 == g)) {
                            x._.tabBarMode = !0;
            ...
            function n(c) {
                if (x == CKEDITOR.dialog._.currentTop) {
                    ...
                    t = y = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) l(d == CKEDITOR.SHIFT + 9 ? -1 : 1), t = 1; else if (d == CKEDITOR.ALT + 121 && !x._.tabBarMode && 1 < x.getPageCount()) x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1, t = 1; else if (-1 != CKEDITOR.tools.indexOf(f, d) && x._.tabBarMode) d = -1 != CKEDITOR.tools.indexOf([g ? 39 : 37, 38], d) ? a.call(x) : e.call(x), x.selectPage(d), x._.tabs[d][0].focus(), t = 1; else if (13 != d && 32 != d || !x._.tabBarMode) if (13 == d) d = c.data.getTarget(), d.is("a", "button", "select", "textarea") || d.is("input") && "button" == d.$.type || ((d = this.getButton("ok")) && CKEDITOR.tools.setTimeout(d.click, 0, d), t = 1), y = 1; else if (27 == d) (d = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(d.click, 0, d) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), y = 1; else return; else this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, l(1), t = 1;
                    w(c)
                }
            }

            function w(a) {
                t ? a.data.preventDefault(1) : y && a.data.stopPropagation()
            }

            var q = CKEDITOR.dialog._.dialogDefinitions[f], z = CKEDITOR.tools.clone(p),
                v = b.config.dialog_buttonsOrder || "OS", r = b.lang.dir, B = {}, t, y;
            ("OS" == v && CKEDITOR.env.mac || "rtl" == v && "ltr" == r || "ltr" == v && "rtl" == r) && z.buttons.reverse();
            q = CKEDITOR.tools.extend(q(b), z);
            q = CKEDITOR.tools.clone(q);
            q = new u(this, q);
            z = m(b);
            this._ = {
                editor: b,
            ...
            z = {position: CKEDITOR.env.ie6Compat ? "absolute" : "fixed", top: 0, visibility: "hidden"};
            z["rtl" == r ? "right" : "left"] = 0;
            this.parts.dialog.setStyles(z);
            CKEDITOR.event.call(this);
            this.definition = q = CKEDITOR.fire("dialogDefinition", {name: f, definition: q}, b).definition;
            if (!("removeDialogTabs" in b._) && b.config.removeDialogTabs) {
                z = b.config.removeDialogTabs.split(";");
                for (r = 0; r < z.length; r++) if (v = z[r].split(":"), 2 == v.length) {
                    var E = v[0];
                    B[E] || (B[E] = []);
                    B[E].push(v[1])
                }
            ...
            if (b._.removeDialogTabs && (B = b._.removeDialogTabs[f])) for (r = 0; r < B.length; r++) q.removeContents(B[r]);
            if (q.onLoad) this.on("load", q.onLoad);
            if (q.onShow) this.on("show", q.onShow);
            if (q.onHide) this.on("hide", q.onHide);
            if (q.onOk) this.on("ok", function (a) {
                b.fire("saveSnapshot");
                setTimeout(function () {
                    b.fire("saveSnapshot")
                }, 0);
                !1 === q.onOk.call(this, a) && (a.data.hide = !1)
            });
            this.state = CKEDITOR.DIALOG_STATE_IDLE;
            if (q.onCancel) this.on("cancel", function (a) {
                !1 === q.onCancel.call(this, a) && (a.data.hide = !1)
            });
            var x = this, A = function (a) {
                var b = x._.contents, c = !1, d;
                for (d in b) for (var g in b[d]) if (c = a.call(this, b[d][g])) return
            };
            this.on("ok", function (a) {
                A(function (b) {
                    if (b.validate) {
                        var d = b.validate(this), g = "string" == typeof d || !1 === d;
                        g && (a.data.hide = !1, a.stop());
                        c.call(b, !g, "string" == typeof d ? d : void 0);
                        return g
                    }
                })
            }, this, null, 0);
            ...
            this.on("show", function () {
                C.on("keydown", n, this);
                if (CKEDITOR.env.gecko) C.on("keypress", w, this)
            });
            this.on("hide", function () {
                C.removeListener("keydown", n);
                CKEDITOR.env.gecko && C.removeListener("keypress", w);
                A(function (a) {
                    d.apply(a)
                })
            });
            ...
            this.on("show", function () {
                ...
                b.config.dialog_startupFocusTab && a ? (x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, q.onFocus ? (a = q.onFocus.call(this)) && a.focus() : l(1))
            ...
            k(this);
            g(this);
            (new CKEDITOR.dom.text(q.title, CKEDITOR.document)).appendTo(this.parts.title);
            for (r = 0; r < q.contents.length; r++) (B = q.contents[r]) && this.addPage(B);
            this.parts.tabs.on("click", function (a) {
                var b = a.data.getTarget();
                b.hasClass("cke_dialog_tab") && (b = b.$.id, this.selectPage(b.substring(4, b.lastIndexOf("_"))), this._.tabBarMode && (this._.tabBarMode = !1, this._.currentFocusIndex = -1, l(1)), a.data.preventDefault())
            }, this);
            r = [];
            ...
            for (r = 0; r < B.length; r++) this._.buttons[B[r].id] = B[r]
        };
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                var d = this._.element.getFirst(), g = "rtl" == this._.editor.lang.dir,
                ...
                f && this._.position && this._.position.x == a && this._.position.y == b || (this._.position = {
                    x: a,
                    y: b
                }, f || (f = CKEDITOR.document.getWindow().getScrollPosition(), a += f.x, b += f.y), g && (f = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - f.width - a), b = {top: (0 < b ? b : 0) + "px"}, b[g ? "right" : "left"] = (0 < a ? a : 0) + "px", d.setStyles(b), c && (this._.moved = 1))
                ...
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, t(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
                a.on("keydown", C);
                a.on("keyup", G);
                this._.hasFocus = !1;
                ...
                var a = this.parts.dialog, b = this.getSize(), c = CKEDITOR.document.getWindow().getViewPaneSize(),
                    d = (c.width - b.width) / 2, g = (c.height - b.height) / 2;
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    }, b), g = this._.contents[a.id] = {}, f = d.getChild(), e = 0; d = f.shift();) d.notAllowed || "hbox" == d.type || "vbox" == d.type || e++, g[d.id] = d, "function" == typeof d.getChild && f.push.apply(f, d.getChild());
                    e || (a.hidden = !0);
                    b = CKEDITOR.dom.element.createFromHtml(b.join(""));
                    b.setAttribute("role", "tabpanel");
                    d = CKEDITOR.env;
                    g = "cke_" + a.id + "_" + CKEDITOR.tools.getNextNumber();
                    c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', g, '"', d.gecko && !d.hc ? "" : ' href\x3d"javascript:void(0)"', ' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e"].join(""));
                    ...
                    a.accessKey && (F(this, this, "CTRL+" + a.accessKey, K, H), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
                }
                ...
                if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
                    ...
                    for (var c in this._.tabs) {
                        var d = this._.tabs[c][0], g = this._.tabs[c][1];
        ...
        var p = {
            ...
            for (var d = 0, g; g = a[d]; d++) if (g.id == b || c && g[c] && (g = w(g[c], b, c))) return g;
            return null
        }, z = function (a, b, c, d, g) {
            if (c) {
                for (var f = 0, e; e = a[f]; f++) {
                    if (e.id == c) return a.splice(f, 0, b), b;
                    if (d && e[d] && (e = z(e[d], b, c, d, !0))) return e
                }
                if (g) return null
            }
            a.push(b);
            ...
            for (var d = 0, g; g = a[d]; d++) {
                ...
                if (c && g[c] && (g = B(g[c], b, c))) return g
            }
            return null
        }, u = function (a, b) {
            this.dialog = a;
            for (var c = b.contents, d = 0, g; g = c[d]; d++) c[d] = g && new h(a, g);
            CKEDITOR.tools.extend(this, b)
        };
        u.prototype = {
        ...
        var y, E = {}, x, A = {}, C = function (a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, d = a.data.$.shiftKey,
                g = String.fromCharCode(a.data.$.keyCode);
            (b = A[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + g]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
        }, G = function (a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, d = a.data.$.shiftKey,
                g = String.fromCharCode(a.data.$.keyCode);
            (b = A[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + g]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
        }, F = function (a, b, c, d, g) {
            (A[c] || (A[c] = [])).push({
                uiElement: a,
                dialog: b,
                key: c,
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, g, f, e) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) || "div", k = ["\x3c", h, " "], m = (g && g.call ? g(b) : g) || {},
                            l = (f && f.call ? f(b) : f) || {}, n = (e && e.call ? e.call(this, a, b) : e) || "",
                            p = this.domId = l.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        b.requiredContent && !a.getParentEditor().filter.check(b.requiredContent) && (m.display = "none", this.notAllowed = !0);
                        l.id = p;
                        var w = {};
                        b.type && (w["cke_dialog_ui_" + b.type] = 1);
                        b.className && (w[b.className] = 1);
                        b.disabled && (w.cke_disabled = 1);
                        for (var q = l["class"] && l["class"].split ? l["class"].split(" ") : [], p = 0; p < q.length; p++) q[p] && (w[q[p]] = 1);
                        q = [];
                        for (p in w) q.push(p);
                        l["class"] = q.join(" ");
                        b.title && (l.title = b.title);
                        w = (b.style || "").split(";");
                        b.align && (q = b.align, m["margin-left"] = "left" == q ? 0 : "auto", m["margin-right"] = "right" == q ? 0 : "auto");
                        for (p in m) w.push(p + ":" + m[p]);
                        b.hidden && w.push("display:none");
                        for (p = w.length - 1; 0 <= p; p--) "" === w[p] && w.splice(p, 1);
                        0 < w.length && (l.style = (l.style ? l.style + "; " : "") + w.join("; "));
                        for (p in l) k.push(p + '\x3d"' + CKEDITOR.tools.htmlEncode(l[p]) + '" ');
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, e = g && g.widths || null, h = g && g.height || null, k,
                            m = {role: "presentation"};
                        g && g.align && (m.align = g.align);
                        CKEDITOR.ui.dialog.uiElement.call(this, a, g || {type: "hbox"}, d, "table", {}, m, function () {
                            ...
                            for (k = 0; k < c.length; k++) {
                                ...
                                e ? e[k] && d.push("width:" + q(e[k])) : d.push("width:" + Math.floor(100 / c.length) + "%");
                                h && d.push("height:" + q(h));
                                g && void 0 !== g.padding && d.push("padding:" + q(g.padding));
                    ...
                    if (!(3 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, e = g && g.width || null, h = g && g.heights || null;
                        CKEDITOR.ui.dialog.uiElement.call(this, a, g || {type: "vbox"}, d, "div", null, {role: "presentation"}, function () {
                            var b = ['\x3ctable role\x3d"presentation" cellspacing\x3d"0" border\x3d"0" '];
                            b.push('style\x3d"');
                            g && g.expand && b.push("height:100%;");
                            b.push("width:" + q(e || "100%"), ";");
                            ...
                            for (var d = 0; d < c.length; d++) {
                                ...
                                h ? k.push("height:" + q(h[d])) : g && g.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
                                g && void 0 !== g.padding && k.push("padding:" + q(g.padding));
        ...
        (function () {
            var a = {
                build: function (a, b, c) {
                    for (var d = b.children, g, f = [], e = [], h = 0; h < d.length && (g = d[h]); h++) {
                        var k = [];
                        f.push(k);
                        e.push(CKEDITOR.dialog._.uiElementBuilders[g.type].build(a, g, k))
                    }
                    return new CKEDITOR.ui.dialog[b.type](a, e, f, c, b)
                }
            };
        ...
        (function () {
            var a = /^([a]|[^a])+$/, b = /^\d*$/, c = /^\d*(?:\.\d+)?$/, d = /^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/,
                g = /^(((\d*(\.\d+))|(\d*))(px|em|ex|in|cm|mm|pt|pc|\%)?)?$/i, f = /^(\s*[\w-]+\s*:\s*[^:;]+(?:;|$))*$/;
            ...
            CKEDITOR.dialog.validate = {
                functions: function () {
                    var a = arguments;
                    return function () {
                        var b = this && this.getValue ? this.getValue() : a[0], c, d = CKEDITOR.VALIDATE_AND, g = [], f;
                        for (f = 0; f < a.length; f++) if ("function" == typeof a[f]) g.push(a[f]); else break;
                        f < a.length && "string" == typeof a[f] && (c = a[f], f++);
                        f < a.length && "number" == typeof a[f] && (d = a[f]);
                        var e = d == CKEDITOR.VALIDATE_AND ? !0 : !1;
                        for (f = 0; f < g.length; f++) e = d == CKEDITOR.VALIDATE_AND ? e && g[f](b) : e || g[f](b);
                        return e ? !0 : c
                    }
                }, regex: function (a, b) {
                    return function (c) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function (a, b) {
                ...
                null === CKEDITOR.dialog._.currentTop && t(this);
        ...
        init: function (a) {
            var e = 0, b = function (b, d, h, k) {
                if (k) {
                    ...
                    var g = c[h];
                    g.unshift(k);
                    a.attachStyleStateChange(k, function (b) {
                        !a.readOnly && a.getCommand(h).setState(b)
                    });
                    a.addCommand(h, new CKEDITOR.styleCommand(k, {contentForms: g}));
            ...
            }, d = a.config, m = a.lang.basicstyles;
            b("Bold", m.bold, "bold", d.coreStyles_bold);
            b("Italic", m.italic, "italic", d.coreStyles_italic);
            b("Underline", m.underline, "underline", d.coreStyles_underline);
            b("Strike", m.strike, "strike", d.coreStyles_strike);
            b("Subscript", m.subscript, "subscript", d.coreStyles_subscript);
            b("Superscript", m.superscript, "superscript", d.coreStyles_superscript);
        ...
        var a = {
            exec: function (a) {
                ...
                if (d) {
                    ...
                    if (CKEDITOR.env.ie) {
                        var l = m[0].startNode, f = m[0].endNode, h;
                        if (l && "blockquote" == l.getParent().getName()) for (h = l; h = h.getNext();) if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
                            l.move(h, !0);
                            break
                        }
                        if (f && "blockquote" == f.getParent().getName()) for (h = f; h = h.getPrevious();) if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
                            f.move(h);
                            break
                        }
                    }
                    ...
                    if (b == CKEDITOR.TRISTATE_OFF) {
                        ...
                        1 > l.length && (b = a.document.createElement(a.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), f = m.shift(), d.insertNode(b), b.append(new CKEDITOR.dom.text("﻿", a.document)), d.moveToBookmark(f), d.selectNodeContents(b), d.collapse(!0), f = d.createBookmark(), l.push(b), m.unshift(f));
                        h = l[0].getParent();
                        d = [];
                        for (f = 0; f < l.length; f++) b = l[f], h = h.getCommonAncestor(b.getParent());
                        for (b = {table: 1, tbody: 1, tr: 1, ol: 1, ul: 1}; b[h.getName()];) h = h.getParent();
                        for (f = null; 0 < l.length;) {
                            for (b = l.shift(); !b.getParent().equals(h);) b = b.getParent();
                            b.equals(f) || d.push(b);
                            f = b
                        }
                        for (; 0 < d.length;) if (b = d.shift(), "blockquote" == b.getName()) {
                            for (f = new CKEDITOR.dom.documentFragment(a.document); b.getFirst();) f.append(b.getFirst().remove()), l.push(f.getLast());
                            f.replace(b)
                        } else l.push(b);
                        d = a.document.createElement("blockquote");
                        for (d.insertBefore(l[0]); 0 < l.length;) b = l.shift(), d.append(b)
                    } else if (b == CKEDITOR.TRISTATE_ON) {
                        f = [];
                        for (h = {}; b = k.getNextParagraph();) {
                            for (l = d = null; b.getParent();) {
                            ...
                            d && l && !l.getCustomData("blockquote_moveout") && (f.push(l), CKEDITOR.dom.element.setMarker(h, l, "blockquote_moveout", !0))
                        }
                        CKEDITOR.dom.element.clearAllMarkers(h);
                        b = [];
                        l = [];
                        for (h = {}; 0 < f.length;) k = f.shift(), d = k.getParent(), k.getPrevious() ? k.getNext() ? (k.breakParent(k.getParent()), l.push(k.getNext())) : k.remove().insertAfter(d) : k.remove().insertBefore(d), d.getCustomData("blockquote_processed") || (l.push(d), CKEDITOR.dom.element.setMarker(h, d, "blockquote_processed", !0)), b.push(k);
                        CKEDITOR.dom.element.clearAllMarkers(h);
        ...
        function e(b) {
            function c() {
                ...
                "beforepaste" == A.mainPasteEvent && (a.on("paste", function (a) {
                    G || (e(), a.data.preventDefault(), y(a), k("paste") || b.openDialog("paste"))
            ...
            function f() {
                return {
                    canUndo: !1, async: !0, exec: function (b, c) {
                        var d = function (c, d) {
                            c && a(b, c, !!d);
                            b.fire("afterCommandExec", {name: "paste", command: f, returnValue: !!c})
                        }, f = this;
                        "string" == typeof c ? d({
                            dataValue: c,
                            method: "paste",
            ...
            function k(a) {
                var c = b.document, d = c.getBody(), f = !1, e = function () {
                    f = !0
                };
                d.on(a, e);
            ...
            function l(a, c) {
                var d = b.document, f = b.editable(), e = function (a) {
                    a.cancel()
                }, h;
                if (!d.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.webkit ? (f.append(n), n.addClass("cke_editable"), f.is("body") || (p = "static" != f.getComputedStyle("position") ? f : CKEDITOR.dom.element.get(f.$.offsetParent), p = p.getDocumentPosition().y)) : f.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
                    n.setStyles({
                        position: "absolute",
                    ...
                    (p = n.getParent().isReadOnly()) ? (n.setOpacity(0), n.setAttribute("contenteditable", !0)) : n.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
                    b.on("selectionChange", e, null, null, 0);
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) h = f.once("blur", e, null, null, -100);
                    p && n.focus();
                    p = new CKEDITOR.dom.range(n);
                    p.selectNodeContents(n);
                    var w = p.select();
                    CKEDITOR.env.ie && (h = f.once("blur", function () {
                        b.lockSelection(w)
                    }));
            ...
            function B() {
                if ("paste" == A.mainPasteEvent) return b.fire("beforePaste", {type: "auto", method: "paste"}), !1;
                b.focus();
                e();
            ...
            function y(c) {
                var d = {type: "auto", method: "paste", dataTransfer: A.initPasteDataTransfer(c)};
            ...
            var A = CKEDITOR.plugins.clipboard, C = 0, G = 0, F = 0;
            (function () {
                b.on("key", u);
                b.on("contentDom", c);
            ...
            (function () {
                function a(c, d, f, e, h) {
                    ...
                    b.addMenuItems && b.addMenuItem(d, {
                        label: k, command: d, group: "clipboard", order: h
                    })
                }

                a("Cut", "cut", d("cut"), 10, 1);
                a("Copy", "copy", d("copy"), 20, 4);
                a("Paste", "paste", f(), 30, 8)
            })();
            b.getClipboardData = function (a, c) {
                ...
                !1 === B() && (b.removeListener("paste", d), h && b.fire("pasteDialog", e) ? (b.on("pasteDialogCommit", f), b.on("dialogHide", function (a) {
                    a.removeListener();
        ...
        function h(b) {
            ...
            b.on("contentDom", function () {
                ...
                function f(d, e) {
                    d.select();
                    a(b, {dataTransfer: e, method: "drop"}, 1);
                ...
                k.attachListener(m, "dragstart", e);
                ...
                k.attachListener(m, "drop", function (a) {
                    if (!a.data.$.defaultPrevented) {
                        ...
                        if (!d.isReadOnly() || d.type == CKEDITOR.NODE_ELEMENT && d.is("html")) {
                            var d = c.getRangeAtDropPosition(a, b), f = c.dragRange;
                            d && e(a, f, d)
                        }
                    }
                }, null, null, 9999);
                ...
                k.attachListener(b, "drop", function (a) {
                    if (a = a.data) {
                        var e = a.dropRange, h = a.dragRange, k = a.dataTransfer;
            ...
            requires: "dialog", init: function (a) {
                ...
                a.on("paste", function (a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        ...
                        for (e.setHtml(b); 1 == e.getChildCount() && (d = e.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));) e = f = d;
                ...
                a.on("paste", function (d) {
                    d = d.data;
                    var f = d.type, e = d.dataValue, h, l = a.config.clipboard_defaultContentType || "html",
                        n = d.dataTransfer.getTransferType(a);
                    h = "html" == f || "html" == d.preSniffing ? "html" : b(e);
                    "htmlifiedtext" == h && (e = c(a.config, e));
                    "text" == f && "html" == h ? e = m(a, e, k.get("plain-text")) : n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (e = m(a, e, a.pasteFilter));
                    d.startsWithEOL && (e = '\x3cbr data-cke-eol\x3d"1"\x3e' + e);
                    d.endsWithEOL && (e += '\x3cbr data-cke-eol\x3d"1"\x3e');
                    "auto" == f && (f = "html" == h || "html" == l ? "html" : "text");
                    d.type = f;
                    d.dataValue = e;
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function (a, b, c, d) {
                function f(a, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(a.getText() + c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0
                }

                var e = b.startContainer;
                "number" == typeof d && "number" == typeof c && e.type == CKEDITOR.NODE_ELEMENT && (f(a.startContainer, e, c) || f(a.endContainer, e, d))
            },
            ...
            internalDrop: function (b, c, d, f) {
                var e = CKEDITOR.plugins.clipboard, h = f.editable(), k, m;
                f.fire("saveSnapshot");
                f.fire("lockSnapshot", {dontUpdate: 1});
                ...
                c = f.createRange();
                c.moveToBookmark(e);
                a(f, {dataTransfer: d, method: "drop", range: c}, 1);
                f.fire("unlockSnapshot")
            },
            getRangeAtDropPosition: function (a, b) {
                var c = a.data.$, d = c.clientX, f = c.clientY, e = b.getSelection(!0).getRanges()[0],
                    h = b.createRange();
                if (a.data.testRange) return a.data.testRange;
                if (document.caretRangeFromPoint) c = b.document.$.caretRangeFromPoint(d, f), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0); else if (c.rangeParent) h.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), h.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (k) {
                                ...
                                var E = b.document.getById(y);
                                h.moveToPosition(E, CKEDITOR.POSITION_BEFORE_START);
                                E.remove()
                            } else {
                                var x = b.document.$.elementFromPoint(d, f), A = new CKEDITOR.dom.element(x), C;
                                if (A.equals(b.editable()) || "html" == A.getName()) return e && e.startContainer && !e.startContainer.equals(b.editable()) ? e : null;
                                C = A.getClientRect();
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function (c, d) {
                this.getHolderElement = function () {
                    ...
                    if (!a) {
                        if (this.isFramed) {
                            var a = this.document.getById(this.id + "_frame"), c = a.getParent(),
                ...
                if (this.isFramed) {
                    ...
                    m.frame = e.output({id: this.id + "_frame", src: l})
                }
                l = a.output(m);
                d && d.push(l);
                return l
        ...
        CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
            $: function (a, b) {
                this.element = a.append(a.getDocument().createElement("div", {
                    attributes: {tabindex: -1, "class": "cke_panel_block"}, styles: {display: "none"}
                }));
                b && CKEDITOR.tools.extend(this, b);
                ...
                show: function () {
                    ...
                    switch (e) {
                        case "next":
                            for (var l = this._.focusIndex, e = this.element.getElementsByTag("a"), f; f = e.getItem(++l);) if (f.getAttribute("_cke_focus") && f.$.offsetWidth) {
                                this._.focusIndex = l;
                                f.focus();
                                break
                            }
                        ...
                        case "prev":
                            l = this._.focusIndex;
                            for (e = this.element.getElementsByTag("a"); 0 < l && (f = e.getItem(--l));) {
                        ...
                        case "click":
                        case "mouseup":
                            return l = this._.focusIndex, (f = 0 <= l && this.element.getElementsByTag("a").getItem(l)) && (f.$[e] ? f.$[e]() : f.$["on" + e]()), !1
                    }
                    return !0
                }
            }
        ...
        function a(a, c, d, m, l) {
            l = CKEDITOR.tools.genKey(c.getUniqueId(), d.getUniqueId(), a.lang.dir, a.uiColor || "", m.css || "", l || "");
            var f = e[l];
            f || (f = e[l] = new CKEDITOR.ui.panel(c, m), f.element = d.append(CKEDITOR.dom.element.createFromHtml(f.render(a), c)), f.element.setStyles({
                display: "none",
                position: "absolute"
            }));
            return f
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, d, e) {
                ...
                addBlock: function (a, c) {
                ...
                }, showBlock: function (a, c, d, e, l, f) {
                    ...
                    var n = this.element, g = this._.iframe,
                        ...
                        q = c.getDocumentPosition(t), t = r ? r.getDocumentPosition(t) : {x: 0, y: 0},
                        v = "rtl" == this._.dir, p = q.x + (e || 0) - t.x, w = q.y + (l || 0) - t.y;
                    !v || 1 != d && 4 != d ? v || 2 != d && 3 != d || (p += c.$.offsetWidth - 1) : p += c.$.offsetWidth;
                    if (3 == d || 4 == d) w += c.$.offsetHeight - 1;
                        ...
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            if (k.autoSize) {
                                var b = k.element.getDocument(),
                                    b = (CKEDITOR.env.webkit ? k.element : b.getBody()).$.scrollWidth;
                            ...
                            var b = h.element.getWindow(), a = n.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                                ...
                                e = v ? a.right : b.width - a.left, g = v ? b.width - a.right : a.left;
                            v ? e < c && (p = g > c ? p + c : b.width > c ? p - a.left : p - a.right + b.width) : e < c && (p = g > c ? p - c : b.width > c ? p - a.right + b.width : p - a.left);
                            c = a.top;
                            b.height - a.top < d && (w = c > d ? w - d : b.height > d ? w - a.bottom + b.height : w - a.top);
                            CKEDITOR.env.ie && (b = a = new CKEDITOR.dom.element(n.$.offsetParent), "html" == b.getName() && (b = b.getDocument().getBody()), "rtl" == b.getComputedStyle("direction") && (p = CKEDITOR.env.ie8Compat ? p - 2 * n.getDocument().getDocumentElement().$.scrollLeft : p - (a.$.scrollWidth - a.$.clientWidth)));
                            var a = n.getFirst(), m;
                            (m = a.getCustomData("activePanel")) && m.onHide && m.onHide.call(this, 1);
                            a.setCustomData("activePanel", this);
                            n.setStyles({top: w + "px", left: p + "px"});
                            n.setOpacity(1);
                            f && f()
                        }, this);
                    ...
                    return c.allowBlur
                }, showAsChild: function (a, c, d, e, l, f) {
                    if (this._.activeChild != a || a._.panel._.offsetParentId != d.getId()) this.hideChild(), a.onHide = CKEDITOR.tools.bind(function () {
                        CKEDITOR.tools.setTimeout(function () {
                            this._.focused || this.hide()
                        }, 0, this)
                    }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, d, e, l, f), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) && setTimeout(function () {
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                var c = CKEDITOR.tools.extend({}, b.panel, {
                    ...
                    block: {}
                }), f = c.block.attributes = c.attributes || {};
                !f.role && (f.role = "menu");
                ...
                add: function (a) {
                    ...
                    if (!g) {
                        ...
                        t["rtl" == k.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
                    ...
                    a(h);
                    for (var t = k.elementPath(), t = ['\x3cdiv class\x3d"cke_menu' + (t && t.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], r = h.length, q = r && h[0].group, v = 0; v < r; v++) {
                        var p = h[v];
                        q != p.group && (t.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), q = p.group);
                        p.render(this, v, t)
                    }
                    t.push("\x3c/div\x3e");
                    n.setHtml(t.join(""));
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, e, l) {
                    var f = a.id + String(e), h = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
                        k = "",
                    ...
                    var n = this.getItems, t = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";",
                        r = this.name;
                        ...
                        a.on("contextmenu", function (a) {
                            ...
                            if (!e || !c) {
                                ...
                                var l = a.getTarget().getDocument(),
                                    ...
                                    c = !l.equals(CKEDITOR.document), l = l.getWindow().getScrollPosition(),
        ...
        function a(a, b) {
            function l(b) {
                b = g.list[b];
                if (b.equals(a.editable()) || "true" == b.getAttribute("contenteditable")) {
                    var c = a.createRange();
            ...
            g.onClick = l;
            var t = CKEDITOR.tools.addFunction(l), r = CKEDITOR.tools.addFunction(function (b, c) {
                var f = g.idBase, e;
                ...
                switch (c.getKeystroke()) {
                    case e ? 39 : 37:
                    case 9:
                        return (e = CKEDITOR.document.getById(f + (b + 1))) || (e = CKEDITOR.document.getById(f + "0")), e.focus(), !1;
                    case e ? 37 : 39:
                    case CKEDITOR.SHIFT + 9:
                        return (e = CKEDITOR.document.getById(f + (b - 1))) || (e = CKEDITOR.document.getById(f + (g.list.length - 1))), e.focus(), !1;
                    case 27:
                        return a.focus(), !1;
                    case 13:
                    case 32:
            ...
            a.on("selectionChange", function () {
                for (var b = [], f = g.list = [], e = [], m = g.filters, l = !0, B = a.elementPath().elements, u, y = B.length; y--;) {
                    var E = B[y], x = 0;
                    u = E.data("cke-display-name") ? E.data("cke-display-name") : E.data("cke-real-element-type") ? E.data("cke-real-element-type") : E.getName();
                    (l = E.hasAttribute("contenteditable") ? "true" == E.getAttribute("contenteditable") : l) || E.hasAttribute("contenteditable") || (x = 1);
                    ...
                    x || (f.unshift(E), e.unshift(u))
                }
                f = f.length;
                for (m = 0; m < f; m++) u = e[m], l = a.lang.elementspath.eleTitle.replace(/%1/, u), u = c.output({
                    id: n + m,
                    label: l,
                    text: u,
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (b) {
                ...
                b.on("dirChanged", function (a) {
                    var d = b.createRange(), f = a.data.node;
                    d.setStartBefore(f);
                    d.setEndAfter(f);
                    for (var e = new CKEDITOR.dom.walker(d), k; k = e.next();) if (k.type == CKEDITOR.NODE_ELEMENT) if (!k.equals(f) && k.getDirection()) d.setStartAfter(k), e = new CKEDITOR.dom.walker(d); else {
                        var g = b.config.indentClasses;
                        if (g) for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], t = 0; t < g.length; t++) k.hasClass(g[t] + n[0]) && (k.removeClass(g[t] + n[0]), k.addClass(g[t] + n[1]));
        ...
        CKEDITOR.plugins.indent.specificDefinition.prototype = {
            execJob: function (a, b) {
                var m = this.jobs[b];
                if (m.state != e) return m.exec.call(this, a)
            }, refreshJob: function (a, b, m) {
                b = this.jobs[b];
                a.activeFilter.checkFeature(this) ? b.state = b.refresh.call(this, a, m) : b.state = e;
                return b.state
        ...
        function a(a) {
            function c(e) {
                for (var h = r.startContainer, l = r.endContainer; h && !h.getParent().equals(e);) h = h.getParent();
                for (; l && !l.getParent().equals(e);) l = l.getParent();
                if (!h || !l) return !1;
                for (var q = h, h = [], v = !1; !v;) q.equals(l) && (v = !0), h.push(q), q = q.getNext();
                if (1 > h.length) return !1;
                q = e.getParents(!0);
                for (l = 0; l < q.length; l++) if (q[l].getName && m[q[l].getName()]) {
                    e = q[l];
                    break
                }
                for (var q = d.isIndent ? 1 : -1, l = h[0], h = h[h.length - 1], v = CKEDITOR.plugins.list.listToArray(e, g), y = v[h.getCustomData("listarray_index")].indent, l = l.getCustomData("listarray_index"); l <= h.getCustomData("listarray_index"); l++) if (v[l].indent += q, 0 < q) {
                    var t = v[l].parent;
                    v[l].parent = new CKEDITOR.dom.element(t.getName(), t.getDocument())
                }
                for (l = h.getCustomData("listarray_index") + 1; l < v.length && v[l].indent > y; l++) v[l].indent += q;
                h = CKEDITOR.plugins.list.arrayToList(v, g, null, a.config.enterMode, e.getDirection());
                if (!d.isIndent) {
                    var x;
                    if ((x = e.getParent()) && x.is("li")) for (var q = h.listNode.getChildren(), A = [], C, l = q.count() - 1; 0 <= l; l--) (C = q.getItem(l)) && C.is && C.is("li") && A.push(C)
                }
                h && h.listNode.replace(e);
                if (A && A.length) for (l = 0; l < A.length; l++) {
                    for (C = e = A[l]; (C = C.getNext()) && C.is && C.getName() in m;) CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(r.document.createText(" ")), e.append(C);
                    e.insertAfter(x)
                }
            ...
            for (var d = this, g = this.database, m = this.context, l = a.getSelection(), l = (l && l.getRanges()).createIterator(), r; r = l.getNextRange();) {
                ...
                q || (q = r.startPath().contains(m)) && r.setEndAt(q, CKEDITOR.POSITION_BEFORE_END);
                if (!q) {
                    var v = r.getEnclosedNode();
                    v && v.type == CKEDITOR.NODE_ELEMENT && v.getName() in m && (r.setStartAt(v, CKEDITOR.POSITION_AFTER_START), r.setEndAt(v, CKEDITOR.POSITION_BEFORE_END), q = v)
                }
                q && r.startContainer.type == CKEDITOR.NODE_ELEMENT && r.startContainer.getName() in m && (v = new CKEDITOR.dom.walker(r), v.evaluator = e, r.startContainer = v.next());
                q && r.endContainer.type == CKEDITOR.NODE_ELEMENT && r.endContainer.getName() in m && (v = new CKEDITOR.dom.walker(r), v.evaluator = e, r.endContainer = v.previous());
                if (q) return c(q)
            }
            return 0
        }
        ...
        var c = CKEDITOR.dom.walker.whitespaces(!0), d = CKEDITOR.dom.walker.bookmark(!1, !0),
            m = CKEDITOR.TRISTATE_DISABLED, l = CKEDITOR.TRISTATE_OFF;
        ...
        function () {
            ...
            function m(a, d, e) {
                ...
                d.trim(!1, !0);
                var h = d.createBookmark(), k = new CKEDITOR.dom.elementPath(d.startContainer), m = k.block,
                    k = k.lastElement.getAscendant("li", 1) || m, r = new CKEDITOR.dom.elementPath(e.startContainer),
                    t = r.contains(CKEDITOR.dtd.$listItem), r = r.contains(CKEDITOR.dtd.$list);
                m ? (m = m.getBogus()) && m.remove() : r && (m = r.getPrevious(g)) && n(m) && m.remove();
                ...
                t && (f = l(t)) && (k.contains(t) ? (b(f, t.getParent(), t), f.remove()) : k.append(f));
                for (; e.checkStartOfBlock() && e.checkEndOfBlock();) {
                    r = e.startPath();
                    f = r.block;
                    if (!f) break;
                    f.is("li") && (k = f.getParent(), f.equals(k.getLast(g)) && f.equals(k.getFirst(g)) && (f = k));
            ...
            var f = {ol: 1, ul: 1}, h = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(),
                g = function (a) {
                    return !(h(a) || k(a))
                ...
                listToArray: function (a, b, c, d, e) {
                    ...
                    for (var g = 0, h = a.getChildCount(); g < h; g++) {
                        ...
                        if ("li" == k.$.nodeName.toLowerCase()) {
                            ...
                            c.push(l);
                            for (var m = 0, n = k.getChildCount(), r; m < n; m++) r = k.getChild(m), r.type == CKEDITOR.NODE_ELEMENT && f[r.getName()] ? CKEDITOR.plugins.list.listToArray(r, b, c, d + 1, l.grandparent) : l.contents.push(r)
                        }
                    }
                    return c
                    ...
                    for (var h, l = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(l), n = null, r = c, t = Math.max(a[c].indent, 0), C = null, G, F, I = d == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                        var H = a[r];
                        h = H.grandparent;
                        G = H.element.getDirection(1);
                        if (H.indent == t) {
                            n && a[r].parent.getName() == n.getName() || (n = a[r].parent.clone(!1, 1), e && n.setAttribute("dir", e), m.append(n));
                            C = n.append(H.element.clone(0, 1));
                            G != n.getDirection(1) && C.setAttribute("dir", G);
                            for (h = 0; h < H.contents.length; h++) C.append(H.contents[h].clone(1, 1));
                            r++
                        } else if (H.indent == Math.max(t, 0) + 1) H = a[r - 1].element.getDirection(1), r = CKEDITOR.plugins.list.arrayToList(a, null, r, d, H != G ? G : null), !C.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= l.$.documentMode && C.append(l.createText(" ")), C.append(r.listNode), r = r.nextIndex; else if (-1 == H.indent && !c && h) {
                            f[h.getName()] ? (C = H.element.clone(!1, !0), G != h.getDirection(1) && C.setAttribute("dir", G)) : C = new CKEDITOR.dom.documentFragment(l);
                            var n = h.getDirection(1) != G, K = H.element, D = K.getAttribute("class"),
                                N = K.getAttribute("style"),
                                R = C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || N || D),
                                P, T = H.contents.length, O;
                            for (h = 0; h < T; h++) if (P = H.contents[h], k(P) && 1 < T) R ? O = P.clone(1, 1) : C.append(P.clone(1, 1)); else if (P.type == CKEDITOR.NODE_ELEMENT && P.isBlockBoundary()) {
                                n && !P.getDirection() && P.setAttribute("dir", G);
                                F = P;
                                var Y = K.getAttribute("style");
                                Y && F.setAttribute("style", Y.replace(/([^;])$/, "$1;") + (F.getAttribute("style") || ""));
                                D && P.addClass(D);
                                F = null;
                                O && (C.append(O), O = null);
                                C.append(P.clone(1, 1))
                            } else R ? (F || (F = l.createElement(I), C.append(F), n && F.setAttribute("dir", G)), N && F.setAttribute("style", N), D && F.setAttribute("class", D), O && (F.append(O), O = null), F.append(P.clone(1, 1))) : C.append(P.clone(1, 1));
                            O && ((F || C).append(O), O = null);
                            C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && r != a.length - 1 && (CKEDITOR.env.needsBrFiller && (G = C.getLast()) && G.type == CKEDITOR.NODE_ELEMENT && G.is("br") && G.remove(), (G = C.getLast(g)) && G.type == CKEDITOR.NODE_ELEMENT && G.is(CKEDITOR.dtd.$block) || C.append(l.createElement("br")));
                            G = C.$.nodeName.toLowerCase();
                            "div" != G && "p" != G || C.appendBogus();
                            m.append(C);
                            n = null;
                            r++
                        } else return null;
                        F = null;
                        if (a.length <= r || Math.max(a[r].indent, 0) < t) break
                    }
            ...
            var t = /^h[1-6]$/, r = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
            e.prototype = {
                exec: function (b) {
                    ...
                    for (var d = e.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
                        var r = l.getBoundaryNodes(), x = r.startNode, A = r.endNode;
                        x.type == CKEDITOR.NODE_ELEMENT && "td" == x.getName() && l.setStartAt(r.startNode, CKEDITOR.POSITION_AFTER_START);
                        A.type == CKEDITOR.NODE_ELEMENT && "td" == A.getName() && l.setEndAt(r.endNode, CKEDITOR.POSITION_BEFORE_END);
                        l = l.createIterator();
                        for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; r = l.getNextParagraph();) if (!r.getCustomData("list_block")) {
                            CKEDITOR.dom.element.setMarker(m, r, "list_block", 1);
                            for (var C = b.elementPath(r), x = C.elements, A = 0, C = C.blockLimit, G, F = x.length - 1; 0 <= F && (G = x[F]); F--) if (f[G.getName()] && C.contains(G)) {
                                C.removeCustomData("list_group_object_" + n);
                                (x = G.getCustomData("list_group_object")) ? x.contents.push(r) : (x = {
                                    root: G,
                                    contents: [r]
                                }, k.push(x), CKEDITOR.dom.element.setMarker(m, G, "list_group_object", x));
                                A = 1;
                                break
                            }
                            A || (A = C, A.getCustomData("list_group_object_" + n) ? A.getCustomData("list_group_object_" + n).contents.push(r) : (x = {
                                root: A,
                                contents: [r]
                            }, CKEDITOR.dom.element.setMarker(m, A, "list_group_object_" + n, x), k.push(x)))
                        }
                    }
                    for (G = []; 0 < k.length;) if (x = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (f[x.root.getName()]) {
                        h = b;
                        n = x;
                        x = m;
                        l = G;
                        ...
                        C = [];
                        for (r = 0; r < n.contents.length; r++) F = n.contents[r], (F = F.getAscendant("li", !0)) && !F.getCustomData("list_item_processed") && (C.push(F), CKEDITOR.dom.element.setMarker(x, F, "list_item_processed", !0));
                        for (var F = n.root.getDocument(), I = void 0, H = void 0, r = 0; r < C.length; r++) {
                            var K = C[r].getCustomData("listarray_index"), I = A[K].parent;
                            I.is(this.type) || (H = F.createElement(this.type), I.copyAttributes(H, {
                                start: 1,
                                type: 1
                            }), H.removeStyle("list-style-type"), A[K].parent = H)
                        }
                        x = CKEDITOR.plugins.list.arrayToList(A, x, null, h.config.enterMode);
                        A = void 0;
                        C = x.listNode.getChildCount();
                        for (r = 0; r < C && (A = x.listNode.getChild(r)); r++) A.getName() == this.type && l.push(A);
                        ...
                        for (F = 0; F < C.length; F++) l = l.getCommonAncestor(C[F].getParent());
                        I = A.config.useComputedState;
                        A = x = void 0;
                        I = void 0 === I || I;
                        for (F = 0; F < C.length; F++) for (H = C[F]; K = H.getParent();) {
                            if (K.equals(l)) {
                                n.push(H);
                        ...
                        if (!(1 > n.length)) {
                            ...
                            r.push(F);
                            for (I = r = void 0; n.length;) r = n.shift(), I = h.createElement("li"), H = r, H.is("pre") || t.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? r.appendTo(I) : (r.copyAttributes(I), x && r.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), r.moveChildren(I), r.remove()), I.appendTo(F);
                            x && A && F.setAttribute("dir", x);
                            C ? F.insertBefore(C) : F.appendTo(l)
                        }
                ...
                requires: "indentlist", init: function (a) {
                    a.blockless || (a.addCommand("numberedlist", new e("numberedlist", "ol")), a.addCommand("bulletedlist", new e("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                        ...
                        if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
                            ...
                            if (h && h.collapsed) {
                                var r = 8 == c, t = a.editable(), E = new CKEDITOR.dom.walker(h.clone());
                                E.evaluator = function (a) {
                                    return g(a) && !n(a)
                                };
                                E.guard = function (a, b) {
                                    return !(b && a.type == CKEDITOR.NODE_ELEMENT && a.is("table"))
                                };
                                c = h.clone();
                                if (r) {
                                    var x;
                                    (x = k.contains(f)) && h.checkBoundaryOfElement(x, CKEDITOR.START) && (x = x.getParent()) && x.is("li") && (x = l(x)) ? (e = x, x = x.getPrevious(g), c.moveToPosition(x && n(x) ? x : e, CKEDITOR.POSITION_BEFORE_START)) : (E.range.setStartAt(t, CKEDITOR.POSITION_AFTER_START), E.range.setEnd(h.startContainer, h.startOffset), (x = E.previous()) && x.type == CKEDITOR.NODE_ELEMENT && (x.getName() in f || x.is("li")) && (x.is("li") || (E.range.selectNodeContents(x), E.reset(), E.evaluator = d, x = E.previous()), e = x, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                                    if (e) m(a, c, h), b.cancel(); else {
                                        var A = k.contains(f);
                                        A && h.checkBoundaryOfElement(A, CKEDITOR.START) && (e = A.getFirst(g), h.checkBoundaryOfElement(e, CKEDITOR.START) && (x = A.getPrevious(g), l(e) ? x && (h.moveToElementEditEnd(x), h.select()) : a.execCommand("outdent"), b.cancel()))
                                    }
                                } else if (e = k.contains("li")) {
                                    if (E.range.setEndAt(t, CKEDITOR.POSITION_BEFORE_END), r = (t = e.getLast(g)) && d(t) ? t : e, k = 0, (x = E.next()) && x.type == CKEDITOR.NODE_ELEMENT && x.getName() in f && x.equals(t) ? (k = 1, x = E.next()) : h.checkBoundaryOfElement(r, CKEDITOR.END) && (k = 2), k && x) {
                                        h = h.clone();
        ...
        function a(a, b, c) {
            ...
            "wysiwyg" == a.mode && (b || (b = a.activeEnterMode), a.elementPath().isContextFor("p") || (b = CKEDITOR.ENTER_BR, c = 1), a.fire("saveSnapshot"), b == CKEDITOR.ENTER_BR ? l(a, b, null, c) : f(a, b, null, c), a.fire("saveSnapshot"))
        }
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (a, f, m, t) {
                if (m = m || e(a)) {
                    m = b(m);
                    var r = m.document, q = m.checkStartOfBlock(), v = m.checkEndOfBlock(),
                        p = a.elementPath(m.startContainer), w = p.block, z = f == CKEDITOR.ENTER_DIV ? "div" : "p", B;
                    if (q && v) {
                        if (w && (w.is("li") || w.getParent().is("li"))) {
                            w.is("li") || (w = w.getParent());
                            m = w.getParent();
                            B = m.getParent();
                            t = !w.hasPrevious();
                            var u = !w.hasNext(), z = a.getSelection(), y = z.createBookmarks(), q = w.getDirection(1),
                                v = w.getAttribute("class"), E = w.getAttribute("style"), x = B.getDirection(1) != q;
                            a = a.enterMode != CKEDITOR.ENTER_BR || x || E || v;
                            if (B.is("li")) t || u ? (t && u && m.remove(), w[u ? "insertAfter" : "insertBefore"](B)) : w.breakParent(B); else {
                                if (a) if (p.block.is("li") ? (B = r.createElement(f == CKEDITOR.ENTER_P ? "p" : "div"), x && B.setAttribute("dir", q), E && B.setAttribute("style", E), v && B.setAttribute("class", v), w.moveChildren(B)) : B = p.block, t || u) B[t ? "insertBefore" : "insertAfter"](m); else w.breakParent(m), B.insertAfter(m); else if (w.appendBogus(!0), t || u) for (; r = w[t ? "getFirst" : "getLast"]();) r[t ? "insertBefore" : "insertAfter"](m); else for (w.breakParent(m); r = w.getLast();) r.insertAfter(m);
                                w.remove()
                            }
                            z.selectBookmarks(y);
                            return
                        ...
                        if (w && w.getParent().is("blockquote")) {
                            w.breakParent(w.getParent());
                            w.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) || w.getPrevious().remove();
                            w.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) || w.getNext().remove();
                            m.moveToElementEditStart(w);
                            m.select();
                            return
                        }
                    } else if (w && w.is("pre") && !v) {
                        l(a, f, m, t);
                        return
                    }
                    if (q = m.splitBlock(z)) {
                        ...
                        p = q.wasStartOfBlock;
                        a = q.wasEndOfBlock;
                        w ? (y = w.getParent(), y.is("li") && (w.breakParent(y), w.move(w.getNext(), 1))) : f && (y = f.getParent()) && y.is("li") && (f.breakParent(y), y = f.getNext(), m.moveToElementEditStart(y), f.move(f.getPrevious()));
                        if (p || a) {
                            if (f) {
                                if (f.is("li") || !h.test(f.getName()) && !f.is("pre")) B = f.clone()
                            } else w && (B = w.clone());
                            B ? t && !B.is("li") && B.renameNode(z) : y && y.is("li") ? B = y : (B = r.createElement(z), f && (u = f.getDirection()) && B.setAttribute("dir", u));
                            if (r = q.elementPath) for (t = 0, z = r.elements.length; t < z; t++) {
                                y = r.elements[t];
                                if (y.equals(r.block) || y.equals(r.blockLimit)) break;
                            ...
                            !CKEDITOR.env.ie || !p || a && f.getChildCount() || (m.moveToElementEditStart(a ? f : B), m.select());
                            m.moveToElementEditStart(p && !a ? w : B)
                        } else w.is("li") && (B = m.clone(), B.selectNodeContents(w), B = new CKEDITOR.dom.walker(B), B.evaluator = function (a) {
                            return !(d(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
                        }, (y = B.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? r.createElement("br") : r.createText(" ")).insertBefore(y)), w && m.moveToElementEditStart(w);
                        m.select();
                        m.scrollIntoView()
                    }
                }
                ...
                if (c = c || e(a)) {
                    var l = c.document, m = c.checkEndOfBlock(),
                        v = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), p = v.block,
                        w = p && v.block.getName();
                    d || "li" != w ? (!d && m && h.test(w) ? (m = p.getDirection()) ? (l = l.createElement("div"), l.setAttribute("dir", m), l.insertAfter(p), c.setStart(l, 0)) : (l.createElement("br").insertAfter(p), CKEDITOR.env.gecko && l.createText("").insertAfter(p), c.setStartAt(p.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == w && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? l.createText("\r") : l.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ? (l.createText("﻿").insertAfter(a), m && (p || v.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : f(a, b, c, d)
                }
            }
        };
        var m = CKEDITOR.plugins.enterkey, l = m.enterBr, f = m.enterBlock, h = /^h[1-6]$/
    }(),function () {
        function a(a, b) {
            var c = {}, d = [], m = {nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"'};
            ...
            if (!b && a) {
                a = a.split(",");
                var l = document.createElement("div"), f;
        ...
        popup: function (a, e, b, c) {
            ...
            640 > e && (e = 640);
            420 > b && (b = 420);
            var d = parseInt((window.screen.height - b) / 2, 10), m = parseInt((window.screen.width - e) / 2, 10);
            c = (c || "location\x3dno,menubar\x3dno,toolbar\x3dno,dependent\x3dyes,minimizable\x3dno,modal\x3dyes,alwaysRaised\x3dyes,resizable\x3dyes,scrollbars\x3dyes") + ",width\x3d" + e + ",height\x3d" + b + ",top\x3d" + d + ",left\x3d" + m;
            var l = window.open("", null, c, !0);
            if (!l) return !1;
            try {
                -1 == navigator.userAgent.toLowerCase().indexOf(" chrome/") && (l.moveTo(m, d), l.resizeTo(e, b)), l.focus(), l.location.href = a
            } catch (f) {
        ...
        function m(a, f, g, l) {
            if (l && l.length) for (var t, r = l.length; r--;) if (t = l[r], "hbox" != t.type && "vbox" != t.type && "fieldset" != t.type || m(a, f, g, t.children), t.filebrowser) if ("string" == typeof t.filebrowser && (t.filebrowser = {
                action: "fileButton" == t.type ? "QuickUpload" : "Browse",
                target: t.filebrowser
            }), "Browse" == t.filebrowser.action) {
                var q = t.filebrowser.url;
                void 0 === q && (q = a.config["filebrowser" + e(f) + "BrowseUrl"], void 0 === q && (q = a.config.filebrowserBrowseUrl));
                q && (t.onClick = b, t.filebrowser.url = q, t.hidden = !1)
            } else if ("QuickUpload" == t.filebrowser.action && t["for"] && (q = t.filebrowser.url, void 0 === q && (q = a.config["filebrowser" + e(f) + "UploadUrl"], void 0 === q && (q = a.config.filebrowserUploadUrl)), q)) {
                var v = t.onClick;
                ...
                t.filebrowser.url = q;
                t.hidden = !1;
                d(a, g.getContents(t["for"][0]).get(t["for"][1]), t.filebrowser)
            }
        }
        ...
        function l(a, b, c) {
            if (-1 !== c.indexOf(";")) {
                c = c.split(";");
                for (var d = 0; d < c.length; d++) if (l(a, b, c[d])) return !0;
                return !1
            }
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            if (a.editor.plugins.filebrowser) for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d) if (c = b.contents[d]) m(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !l(b, c.id, c.filebrowser))
        })
    }(),function () {
        function a(a) {
            var d = a.config, m = a.fire("uiSpace", {space: "top", html: ""}).html, l = function () {
                function f(a, c, d) {
                    h.setStyle(c, b(d));
                ...
                function g(a) {
                    ...
                    switch (a) {
                        case "top":
                            f("absolute", "top", b.y - z - y);
                            break;
                        case "pin":
                            f("fixed", "top", x);
                            break;
                        case "bottom":
                            f("absolute", "top", b.y + (p.height || p.bottom - p.top) + y)
                    }
                    k = a
                }

                var k, m, v, p, w, z, B, u = d.floatSpaceDockedOffsetX || 0, y = d.floatSpaceDockedOffsetY || 0,
                    E = d.floatSpacePinnedOffsetX || 0, x = d.floatSpacePinnedOffsetY || 0;
                return function (f) {
                    if (m = a.editable()) {
            ...
            if (m) {
                var f = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"' + (CKEDITOR.env.gecko ? " " : "") + '" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : " ") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' : " ") + '\x3cdiv class\x3d"cke_inner"\x3e\x3cdiv id\x3d"{topId}" class\x3d"cke_top" role\x3d"presentation"\x3e{content}\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'),
                    h = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(f.output({
                        content: m,
                        id: a.id,
                        langDir: a.lang.dir,
                        langCode: a.langCode,
                        ...
                        voiceLabel: a.title
                    }))), k = CKEDITOR.tools.eventsBuffer(500, l), g = CKEDITOR.tools.eventsBuffer(100, l);
                h.unselectable();
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, d) {
                ...
                var l = CKEDITOR.env, f = this._.id = CKEDITOR.tools.getNextId(), h = "", k = this.command, g;
                this._.editor = a;
                var n = {
                ...
                k || (h += "off");
                var p = this.name || this.command, w = p;
            ...
            CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
                $: function (a) {
                    ...
                    renderHtml: function (a) {
                        ...
                        var m = CKEDITOR.env, l = "cke_" + this.id, f = CKEDITOR.tools.addFunction(function (c) {
                            t && (a.unlockSelection(1), t = 0);
                            k.execute(c)
                        }, this), h = this, k = {
                            id: l, combo: this, focus: function () {
                        ...
                        if (!this._.panel) {
                            var c = this._.panelDefinition, d = this._.panelDefinition.block,
                                e = c.parent || CKEDITOR.document.getBody(), l = "cke_combopanel__" + this.name,
                                f = new CKEDITOR.ui.floatPanel(a, e, c), h = f.addListBlock(this.id, d), k = this;
                            f.onShow = function () {
        ...
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var e = a.config, b = a.lang.format, c = e.format_tags.split(";"), d = {}, m = 0, l = [], f = 0; f < c.length; f++) {
                    var h = c[f], k = new CKEDITOR.style(e["format_" + h]);
                    if (!a.filter.customConfig || a.filter.check(k)) m++, d[h] = k, d[h]._.enterMode = a.config.enterMode, l.push(k)
                }
                ...
                function c(c) {
                    ...
                    if (m) {
                        ...
                        m.on("refresh", function (l) {
                            var f = a(b);
                            f && (f = e(f), this.setState(f == c ? CKEDITOR.TRISTATE_ON : "right" == c || "left" == c ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), l.cancel())
                        })
                    }
                }
        ...
        var e = CKEDITOR.htmlParser.cssStyle, b = CKEDITOR.tools.cssLength, c = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i,
            d = {
                elements: {
                    $: function (b) {
                        var c = b.attributes;
        ...
        var d = /^javascript:/, m = /^mailto:([^?]+)(?:\?(.+))?$/, l = /subject=([^;?:@&=$,\/]*)/i,
            f = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, k = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a) {
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    e = a.plugins.link.compiledProtectionFunction, u = a.config.emailProtection, y, E = {};
                c.match(d) && ("encode" == u ? c = c.replace(n, function (a, b, c) {
                    c = c || "";
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
                }) : u && c.replace(t, function (a, b, c) {
                    if (b == e.name) {
                        E.type = "email";
                        a = E.email = {};
                        b = /(^')|('$)/g;
                ...
                if (!E.type) if (u = c.match(h)) E.type = "anchor", E.anchor = {}, E.anchor.name = E.anchor.id = u[1]; else if (u = c.match(m)) {
                    y = c.match(l);
                    c = c.match(f);
                    E.type = "email";
                    var x = E.email = {};
                ...
                } else c && (y = c.match(k)) && (E.type = "url", E.url = {}, E.url.protocol = y[1], E.url.url = y[2]);
                if (b) {
                    if (c = b.getAttribute("target")) E.target = {
                        type: c.match(g) ? c : "frame",
                        name: c
                    }; else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(r)) for (E.target = {
                        type: "popup",
                        name: c[1]
                    }; u = q.exec(c[2]);) "yes" != u[2] && "1" != u[2] || u[1] in {
                        height: 1,
                        width: 1,
                        top: 1,
                        left: 1
                    } ? isFinite(u[2]) && (E.target[u[1]] = u[2]) : E.target[u[1]] = !0;
                    var c = {}, A;
                    for (A in v) (u = b.getAttribute(A)) && (c[v[A]] = u);
                    if (A = b.data("cke-saved-name") || c.advName) c.advName = A;
                    CKEDITOR.tools.isEmpty(c) || (E.advanced = c)
                }
                return E
                ...
                switch (d.type) {
                    ...
                    case "anchor":
                        ...
                        break;
                    case "email":
                        var k = d.email, h = k.address;
                        switch (f) {
                            case "":
                            case "encode":
                                var l = encodeURIComponent(k.subject || ""), m = encodeURIComponent(k.body || ""),
                                    k = [];
                ...
                if (d.target) if ("popup" == d.target.type) {
                    for (var f = ["window.open(this.href, '", d.target.name || "", "', '"], n = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "), h = n.length, l = function (a) {
                ...
                if (d.advanced) {
                    for (var q in v) (f = d.advanced[v[q]]) && (g[q] = f);
                    g.name && (g["data-cke-saved-name"] = g.name)
                }
                g["data-cke-saved-href"] && (g.href = g["data-cke-saved-href"]);
                q = {target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1};
                d.advanced && CKEDITOR.tools.extend(q, v);
                for (var r in g) delete q[r];
                return {set: g, removed: CKEDITOR.tools.objectKeys(q)}
            }
        };
        ...
        function d(a, b, c) {
            return b = b[c ? "getPrevious" : "getNext"](function (b) {
                return b && b.type == CKEDITOR.NODE_TEXT && !ba(b) || n(b) && !t(b) && !g(a, b)
            })
        }
        ...
        function f(a) {
            var b = a.doc,
                c = G('\x3cspan contenteditable\x3d"false" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', b),
            ...
            A(c, {
                ...
                lineChildren: [A(G('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', b), {
                    base: Q + "height:17px;width:17px;" + (a.rtl ? "left" : "right") + ":17px;background:url(" + d + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (F.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" : "") + (F.hidpi ? "background-size: 9px 10px;" : ""),
                    looks: ["top:-8px; border-radius: 2px;", "top:-17px; border-radius: 2px 2px 0px 0px;", "top:-1px; border-radius: 0px 0px 2px 2px;"]
                }), A(G(V, b), {
                    base: aa + "left:0px;border-left-color:" + a.boxColor + ";",
                    looks: ["border-width:8px 0 8px 8px;top:-8px", "border-width:8px 0 0 8px;top:-8px", "border-width:0 0 8px 8px;top:0px"]
                }), A(G(V, b), {
                    base: aa + "right:0px;border-right-color:" + a.boxColor + ";",
        ...
        function h(a, b, c) {
            ...
            F.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(M) : (f = (f = l(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f = new C(K[f], a.doc), f.is("br") || a.doc.createText(M).appendTo(f));
            ...
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    ...
                    return function (f) {
                        ...
                        var g;
                        f = f.getAscendant(L, 1);
                        if (!v(a, f) && f && !f.equals(a.editable) && !f.contains(a.editable)) {
                            (g = l(f)) && "false" == g.getAttribute("contenteditable") && (f = g);
                            a.element = f;
                            g = d(a, f, !c);
                            var h;
                            n(g) && g.is(a.triggers) && g.is(J) && (!d(a, g, !c) || (h = d(a, g, !c)) && n(h) && h.is(a.triggers)) ? e(g) : (h = b(a, f), n(h) && (d(a, h, !c) ? (f = d(a, h, !c)) && n(f) && f.is(a.triggers) && e(h) : e(h)))
                        }
                    }
                }()
            }
        ...
        function w(a) {
            ...
            if (!n(b) || t(b) || !q(a, b)) return null;
            u(a, b);
            return !h && 0 <= b.size.top && m(c.y, 0, b.size.top + f) ? (a = a.inInlineMode || 0 === d.scroll.y ? T : Y, new e([null, b, D, P, a])) : h && b.size.bottom <= d.pane.height && m(c.y, b.size.bottom - f, d.pane.height) ? (a = a.inInlineMode || m(b.size.bottom, d.pane.height - f, d.pane.height) ? O : Y, new e([b, null, N, P, a])) : null
        }
        ...
        function z(a) {
            ...
            if (!h) return null;
            u(a, h);
            var g = Math.min(g, 0 | h.size.outerHeight / 2), k = [], l, r;
            if (m(c.y, h.size.top - 1, h.size.top + g)) r = !1; else if (m(c.y, h.size.bottom - g, h.size.bottom + 1)) r = !0; else return null;
            if (t(h) || p(a, h, r) || h.getParent().is(W)) return null;
            var v = d(a, h, !r);
            if (v) {
                if (v && v.type == CKEDITOR.NODE_TEXT) return null;
                if (n(v)) {
                    if (t(v) || !q(a, v) || v.getParent().is(W)) return null;
                    k = [v, h][r ? "reverse" : "concat"]().concat([R, P])
                }
            } else h.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? (y(a), r && m(c.y, h.size.bottom - g, f.pane.height) && m(h.size.bottom, f.pane.height - g, f.pane.height) ? l = O : m(c.y, 0, h.size.top + g) && (l = T)) : l = Y, k = [null, h][r ? "reverse" : "concat"]().concat([r ? N : D, P, l, h.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? r ? O : T : Y]);
            return 0 in k ? new e(k) : null
        }

        function B(a, b, c, d) {
            for (var e = b.getDocumentPosition(), f = {}, g = {}, h = {}, k = {}, l = ca.length; l--;) f[ca[l]] = parseInt(b.getComputedStyle.call(b, "border-" + ca[l] + "-width"), 10) || 0, h[ca[l]] = parseInt(b.getComputedStyle.call(b, "padding-" + ca[l]), 10) || 0, g[ca[l]] = parseInt(b.getComputedStyle.call(b, "margin-" + ca[l]), 10) || 0;
            c && !d || E(a, d);
        ...
        function x(a, b, c, d) {
            for (var f = d, g = d, h = 0, k = !1, l = !1, m = a.view.pane.height, n = a.mouse; n.y + h < m && 0 < n.y - h;) {
                k || (k = b(f, d));
                l || (l = b(g, d));
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                var c = a.config, l = c.magicline_triggerOffset || 30, m = {
                    ...
                    triggers: c.magicline_everywhere ? L : {
                        table: 1,
                        hr: 1,
                        div: 1,
                        ul: 1,
                ...
                m.isRelevant = function (a) {
                    return n(a) && !g(m, a) && !t(a)
                };
                a.on("contentDom", function () {
                    var l = a.editable(), n = a.document, t = a.window;
                    A(m, {editable: l, inInlineMode: l.isInline(), doc: n, win: t, hotNode: null}, !0);
                    m.boundary = m.inInlineMode ? m.editable : m.doc.getDocumentElement();
                    l.is(H.$inline) || (m.inInlineMode && !r(l) && l.setStyles({
                        position: "relative",
                        top: null,
                        left: null
                    }), f.call(this, m), E(m), l.attachListener(a, "beforeUndoImage", function () {
                        m.line.detach()
                        ...
                        if ("wysiwyg" == a.mode) if (m.inInlineMode) {
                            ...
                            c > d.left - e.x && c < d.right - e.x && b > d.top - e.y && b < d.bottom - e.y || (clearTimeout(u), u = null, m.line.detach())
                        ...
                        if ("wysiwyg" == a.mode && !a.readOnly && !u) {
                            ...
                            u = setTimeout(function () {
                                ...
                                u = m.trigger = null;
                                E(m);
                                p && !m.hiddenMode && a.focusManager.hasFocus && !m.line.mouseNear() && (m.element = da(m, !0)) && ((m.trigger = w(m) || z(m) || ea(m)) && !v(m, m.trigger.upper || m.trigger.lower) ? m.line.attach().place() : (m.trigger = null, m.line.detach()), p = !1)
                            }, 30)
                        }
                    }), l.attachListener(t, "scroll", function () {
                        "wysiwyg" == a.mode && (m.line.detach(), F.webkit && (m.hiddenMode = 1, clearTimeout(q), q = setTimeout(function () {
                            m.mouseDown || (m.hiddenMode = 0)
                        }, 50)))
                    }), l.attachListener(I ? n : t, "mousedown", function () {
                        "wysiwyg" == a.mode && (m.line.detach(), m.hiddenMode = 1, m.mouseDown = 1)
                    }), l.attachListener(I ? n : t, "mouseup", function () {
                        m.hiddenMode = 0;
                        m.mouseDown = 0
        ...
        var A = CKEDITOR.tools.extend, C = CKEDITOR.dom.element, G = C.createFromHtml, F = CKEDITOR.env,
            I = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, H = CKEDITOR.dtd, K = {}, D = 128, N = 64, R = 32, P = 16,
            T = 4, O = 2, Y = 1, M = " ", W = H.$listItem, U = H.$tableContent, J = A({}, H.$nonEditable, H.$empty),
            L = H.$block, S = 100,
            ...
            aa = Q + "border-color:transparent;display:block;border-style:solid;",
            V = "\x3cspan\x3e" + M + "\x3c/span\x3e";
        K[CKEDITOR.ENTER_BR] = "br";
        K[CKEDITOR.ENTER_P] = "p";
        K[CKEDITOR.ENTER_DIV] = "div";
        e.prototype = {
            set: function (a, b, c) {
                this.properties = a + b + (c || Y);
                return this
            }, is: function (a) {
        ...
        var da = function () {
            ...
            }(), ba = CKEDITOR.dom.walker.whitespaces(), X = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),
            ea = function () {
                function b(e) {
                    ...
                    for (var f = Number.MAX_VALUE, l, q, r, p; h && !h.equals(g) && (q = g.getNext(e.isRelevant));) l = Math.abs(c(e, g, q) - e.mouse.y), l < f && (f = l, r = g, p = q), g = q, u(e, g);
                    if (!r || !p || !m(e.mouse.y, r.size.top, p.size.bottom)) return null;
                    k.upper = r;
                    k.lower = p;
                    return k.set(R, 8)
                }
                ...
                function d(a, b) {
                    return !(b && b.type == CKEDITOR.NODE_TEXT || X(b) || t(b) || g(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br"))
                }
                ...
                return function (c) {
                    ...
                    if (e = d) {
                        e = d.upper;
                        var f = d.lower;
                        e = !e || !f || t(f) || t(e) || f.equals(e) || e.equals(f) || f.contains(e) || e.contains(f) ? !1 : q(c, e) && q(c, f) && a(c, e, f) ? !0 : !1
                    }
                    return e ? d : null
                }
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var f = a.lang, h = CKEDITOR.document, k = h.getWindow(), g, n, t, r = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                k.on("resize", e);
                                t = k.getScrollPosition();
                                for (p = a.container; p = p.getParent();) p.setCustomData("maximize_saved_styles", b(p)), p.setStyle("z-index", a.config.baseFloatZIndex - 5);
                                ...
                                q.$.offsetLeft;
                                q.setStyles({"z-index": a.config.baseFloatZIndex - 5, left: "0px", top: "0px"});
                                q.addClass("cke_maximized");
                                e();
                                v = q.getDocumentPosition();
                                q.setStyles({left: -1 * v.x + "px", top: -1 * v.y + "px"});
                                CKEDITOR.env.gecko && d(a)
                            } else if (this.state == CKEDITOR.TRISTATE_ON) {
                                k.removeListener("resize", e);
                                for (var p = [v, q], z = 0; z < p.length; z++) c(p[z], p[z].getCustomData("maximize_saved_styles")), p[z].removeCustomData("maximize_saved_styles");
                                for (p = a.container; p = p.getParent();) c(p, p.getCustomData("maximize_saved_styles")), p.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function () {
                                    k.$.scrollTo(t.x, t.y)
                                }, 0) : k.$.scrollTo(t.x, t.y);
                            ...
                            this.toggleState();
                            if (p = this.uiItems[0]) v = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, p = CKEDITOR.document.getById(p._.id), p.getChild(1).setHtml(v), p.setAttribute("title", v), p.setAttribute("href", 'javascript:void("' + v + '");');
                            "wysiwyg" == a.mode ? g ? (CKEDITOR.env.gecko && d(a), a.getSelection().selectRanges(g), (w = a.getSelection().getStartElement()) && w.scrollIntoView(!0)) : k.$.scrollTo(n.x, n.y) : (g && (w.selectionStart = g[0], w.selectionEnd = g[1]), w.scrollLeft = n[0], w.scrollTop = n[1]);
                            g = n = null;
                            r = this.state;
        ...
        function a(a, c, d) {
            ...
            e ? d() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || c + "filter/default.js"), CKEDITOR.scriptLoader.load(a, d, null, !0));
            return !e
        }
        ...
        CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard", init: function (b) {
                ...
                b.on("paste", function (e) {
                    var l = e.data, f = l.dataValue;
                    if (f && (c || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(f))) {
                        l.dontFilter = !0;
                        var h = a(b, d, function () {
                            if (h) b.fire("paste", l); else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup)) l.dataValue = CKEDITOR.cleanWord(f, b);
                            c = 0
                        });
                        h && e.cancel()
                    }
            ...
            canUndo: !1, async: !0, exec: function (e) {
                e.getClipboardData({title: e.lang.pastetext.title}, function (b) {
                    ...
                    e.fire("afterCommandExec", {
                        name: "pastetext", command: a, returnValue: !!b
                    })
                })
            }
        };
        ...
        commands: {
            removeformat: {
                exec: function (a) {
                    for (var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, d = a.getSelection().getRanges(), m = d.createIterator(), l = function (a) {
                        return a.type == CKEDITOR.NODE_ELEMENT
                    }, f; f = m.getNextRange();) {
                        f.collapsed || f.enlarge(CKEDITOR.ENLARGE_ELEMENT);
                        var h = f.createBookmark(), k = h.startNode, g = h.endNode, n = function (b) {
                            for (var d = a.elementPath(b), f = d.elements, g = 1, h; (h = f[g]) && !h.equals(d.block) && !h.equals(d.blockLimit); g++) e.test(h.getName()) && c(a, h) && b.breakParent(h)
                        };
                        n(k);
        ...
        init: function (a) {
            function e(b) {
                var d = h.width, e = h.height, l = d + (b.data.$.screenX - f.x) * ("rtl" == m ? -1 : 1);
                b = e + (b.data.$.screenY - f.y);
                k && (d = Math.max(c.resize_minWidth, Math.min(l, c.resize_maxWidth)));
            ...
            var c = a.config, d = a.ui.spaceId("resizer"), m = a.element ? a.element.getDirection(1) : "ltr";
            ...
            if (!1 !== c.resize_enabled) {
                var l = null, f, h,
                    ...
                    n = CKEDITOR.tools.addFunction(function (d) {
                        l || (l = a.getResizable());
                        h = {width: l.$.offsetWidth || 0, height: l.$.offsetHeight || 0};
                ...
                a.on("uiSpace", function (b) {
                    if ("bottom" == b.data.space) {
                        ...
                        var e = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' + c + " cke_resizer_" + m + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == m ? "◢" : "◣") + "\x3c/span\x3e";
                        "ltr" == m && "ltr" == c ? b.data.html += e : b.data.html = e + b.data.html
                    }
                }, a, null, 100);
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
                ...
                modes: {wysiwyg: !(d.ie && (8 > d.version || d.quirks))},
            ...
            c = {
                ...
                scaytDict: {
                    label: a.lang.scayt.btn_dictionaries, group: "scaytButton", command: "scaytDict"
                }
            };
            a.plugins.wsc && (c.WSC = {
            ...
            var e = CKEDITOR.plugins.scayt, b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, c = function () {
                ...
                c.attachListener(c, "focus", function (c) {
                    ...
                    if ((b || c) && a._.savedSelection) {
                        ...
                        for (var l = 0; l < c.length; l++) f = c[l], "string" === typeof f.startContainer.$.nodeValue && (e = f.startContainer.getText().length, (e < f.startOffset || e < f.endOffset) && a.unlockSelection(!1))
                    }
                }, this, null, -10)
            }, l = function () {
            ...
            a.on("afterCommandExec", function (b) {
                "wysiwyg" != a.mode || "undo" != b.data.name && "redo" != b.data.name || setTimeout(function () {
                    ...
                    c && c.ltr && c.rtl && b.fire("startSpellCheck, startGrammarCheck")
                }, 250)
            });
            a.on("readOnly", function (b) {
                var c;
                b && (c = a.scayt, !0 === b.editor.readOnly ? c && c.fire("removeMarkupInDocument", {}) : c ? c.fire("startSpellCheck, startGrammarCheck") : "wysiwyg" == b.editor.mode && !0 === e.state.scayt[b.editor.name] && (e.createScayt(a), b.editor.fire("scaytButtonState", CKEDITOR.TRISTATE_ON)))
            });
            ...
            a.on("reloadMarkupScayt", function (b) {
                ...
                setTimeout(function () {
                    ...
                    d && d.ltr && d.rtl && (a.document.fire("keydown", new CKEDITOR.dom.event({keyCode: 37})), b.removeMarkupInSelectionNode(c), b.fire("startSpellCheck, startGrammarCheck"))
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var e = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    ...
                    l = CKEDITOR.tools.search, f = CKEDITOR.tools.indexOf;
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], c = 0; c < a.length; c++) {
                        var e = a[c], t = !!l(a, "options");
                        if (!l(d, e) || t && l(m, function (a) {
                            if ("lang" === a) return !1
                        })) return;
                        l(m, e) && m.splice(f(m, e), 1);
                        if ("all" === e || t && l(a, "lang")) return [];
                        "options" === e && (m = ["lang"])
                    }
                    return b = b.concat(m)
                }(e)
            ...
            var e = CKEDITOR.plugins.scayt, b = a.dataProcessor, c = b && b.htmlFilter,
                d = a._.elementsPath && a._.elementsPath.filters, b = b && b.dataFilter, m = a.addRemoveFormatFilter,
                l = function (b) {
            ...
            var c = {}, d = {}, m = b ? "word" : "phrase", l = b ? "startGrammarCheck" : "startSpellCheck", f = a.scayt;
            ...
            } else for (b = 0; b < e.length; b++) h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], m, l)), a.addMenuItem(h, {
                label: e[b],
                command: h,
                group: "grayt_suggest",
                order: b + 1
            ...
            var b = a.scayt, c = this.scaytMenuDefinition(a), d = {}, m = a.config.scayt_contextCommands.split("|"),
                l = e.getAttribute(b.getLangAttribute()) || b.getLang(), f, h;
            f = b.isScaytNode(e);
            h = b.isGraytNode(e);
            f ? (c = c.scayt, d = e.getAttribute(b.getScaytNodeAttributeName()), b.fire("getSuggestionsList", {
                lang: l,
                word: d
            }), d = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, f)) : h && (c = c.grayt, d = e.getAttribute(b.getGraytNodeAttributeName()), h = b.getProblemDescriptionText(d, l), c.grayt_problemdescription && h && (c.grayt_problemdescription.label = h), b.fire("getGrammarSuggestionsList", {
                lang: l,
                phrase: d
            }), d = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, f));
            if (f && "off" == a.config.scayt_contextCommands) return d;
            for (var k in c) f && -1 == CKEDITOR.tools.indexOf(m, k.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (d[k] = "undefined" != typeof c[k].state ? c[k].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[k].verification || c[k].verification(a) || delete d[k], a.addCommand(k, {exec: c[k].exec}), a.addMenuItem(k, {
        ...
        createScayt: function (a) {
            ...
            this.loadScaytLibrary(a, function (a) {
                var d = a.window && a.window.getFrame() || a.editable();
                d ? (d = {
                ...
                }, a.config.scayt_serviceProtocol && (d.service_protocol = a.config.scayt_serviceProtocol), a.config.scayt_serviceHost && (d.service_host = a.config.scayt_serviceHost), a.config.scayt_servicePort && (d.service_port = a.config.scayt_servicePort), a.config.scayt_servicePath && (d.service_path = a.config.scayt_servicePath), "boolean" === typeof a.config.scayt_ignoreAllCapsWords && (d["ignore-all-caps-words"] = a.config.scayt_ignoreAllCapsWords), "boolean" === typeof a.config.scayt_ignoreDomainNames && (d["ignore-domain-names"] = a.config.scayt_ignoreDomainNames), "boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases && (d["ignore-words-with-mixed-cases"] = a.config.scayt_ignoreWordsWithMixedCases), "boolean" === typeof a.config.scayt_ignoreWordsWithNumbers && (d["ignore-words-with-numbers"] = a.config.scayt_ignoreWordsWithNumbers), d = new SCAYT.CKSCAYT(d, function () {
                }, function () {
                }), d.subscribe("suggestionListSend", function (a) {
        ...
        loadScaytLibrary: function (a, e) {
            var b = this, c, d;
            this.loadingHelper[a.name] || ("undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = e, this.loadingHelper.loadOrder.push(a.name), c = new Date, c = c.getTime(), d = a.config.scayt_srcUrl, d += 0 <= d.indexOf("?") ? "" : "?" + c, this.loadingHelper.ckscaytLoading || (CKEDITOR.scriptLoader.load(d, function (a) {
                if (a) {
                    CKEDITOR.fireOnce("scaytReady");
                    for (var c = 0; c < b.loadingHelper.loadOrder.length; c++) {
                        a = b.loadingHelper.loadOrder[c];
                        if ("function" === typeof b.loadingHelper[a]) b.loadingHelper[a](CKEDITOR.instances[a]);
                ...
                return function () {
                    ...
                    if (CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[this.name] && this.scayt) {
                        if (c = "ready" == this.status) var e = d.removeMarkupFromString(this.getSnapshot()),
                            d = d.removeMarkupFromString(this._.previousValue), c = c && d !== e
                    } else c = a.call(this);
                    return c
                }
            });
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[e] = CKEDITOR.tools.override(a[e], function (a) {
                return function (c) {
                    var d = c.editor.scayt, e = this.contents, l = c.contents, f = null;
                    CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[c.editor.name] && c.editor.scayt && (this.contents = d.removeMarkupFromString(e) || "", c.contents = d.removeMarkupFromString(l) || "");
        ...
        CKEDITOR.plugins.add("showborders", {
            modes: {wysiwyg: 1}, onLoad: function () {
                ...
                e.on("removeFormatCleanup", function (a) {
                    a = a.data;
                    e.getCommand("showborders").state == CKEDITOR.TRISTATE_ON && a.is("table") && (!a.hasAttribute("border") || 0 >= parseInt(a.getAttribute("border"), 10)) && a.addClass("cke_show_border")
                })
            }, afterInit: function (a) {
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            ...
            if ("table" == b || "tableProperties" == b) if (a = a.data.definition, b = a.getContents("info").get("txtBorder"), b.commit = CKEDITOR.tools.override(b.commit, function (a) {
                return function (b, e) {
                    ...
                    e[!l || 0 >= l ? "addClass" : "removeClass"]("cke_show_border")
                }
                ...
                requires: "richcombo", init: function (a) {
                    ...
                    a.ui.addRichCombo("Styles", {
                        ...
                        init: function () {
                            var a, c, e, k, g, m;
                            g = 0;
                            for (m = d.length; g < m; g++) a = d[g], c = a._name, k = a._.type, k != e && (this.startGroup(b["panelTitle" + String(k)]), e = k), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
                            this.commit()
                        },
                        onClick: function (b) {
                            a.focus();
                        ...
                        onOpen: function () {
                            var d = a.getSelection().getSelectedElement(), d = a.elementPath(d), e = [0, 0, 0, 0];
                            this.showAll();
                            this.unmarkAll();
                            for (var h in c) {
        ...
        CKEDITOR.plugins.add("tab", {
            init: function (d) {
                for (var m = !1 !== d.config.enableTabKeyTools, l = d.config.tabSpaces || 0, f = ""; l--;) f += " ";
                if (f) d.on("key", function (a) {
                    9 == a.data.keyCode && (d.insertText(f), a.cancel())
                });
                if (m) d.on("key", function (a) {
        ...
        var b = void 0 === e ? this.getTabIndex() : e, c, d, m, l, f, h;
        if (0 >= b) for (f = this.getNextSourceNode(a, CKEDITOR.NODE_ELEMENT); f;) {
            ...
            if (f.isVisible() && !(0 > (h = f.getTabIndex()))) {
                ...
                h > b && (!m || !l || h < l) ? (m = f, l = h) : m || 0 !== h || (m = f, l = h)
            }
        }
        m && m.focus()
    },CKEDITOR.dom.element.prototype.focusPrevious = function (a, e) {
        for (var b = void 0 === e ? this.getTabIndex() : e, c, d, m, l = 0, f, h = this.getDocument().getBody().getLast(); h = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
            ...
            if (!a.blockless) {
                ...
                a.addCommand("tableDelete", e({
                    exec: function (a) {
                        ...
                        if (b) {
                            var e = b.getParent(), l = a.editable();
                            1 != e.getChildCount() || e.is("td", "th") || e.equals(l) || (b = e);
                            a = a.createRange();
        ...
        function a(a) {
            function b(a) {
                0 < c.length || a.type != CKEDITOR.NODE_ELEMENT || !t.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(d, a, "selected_cell", !0), c.push(a))
            }
            ...
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], g = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], h = c; h <= g; h++) {
                    for (var k = f[h], l = new CKEDITOR.dom.element(e.$.rows[h]), m = 0; m < k.length; m++) {
                        var n = new CKEDITOR.dom.element(k[m]), t = n.getParent().$.rowIndex;
                        1 == n.$.rowSpan ? n.remove() : (--n.$.rowSpan, t == h && (t = f[h + 1], t[m - 1] ? n.insertAfter(new CKEDITOR.dom.element(t[m - 1])) : (new CKEDITOR.dom.element(e.$.rows[h + 1])).append(n, 1)));
                        m += n.$.colSpan - 1
                    }
                    d.push(l)
                }
        ...
        function l(b) {
            if (b instanceof CKEDITOR.dom.selection) {
                ...
                a:{
                    var e = 0;
                    d = b.length - 1;
                    for (var g = {}, h, k; h = b[e++];) CKEDITOR.dom.element.setMarker(g, h, "delete_cell", !0);
        ...
        function k(b, c, d) {
            ...
            var k = CKEDITOR.tools.buildTableMap(f), l = k.length, m = k[0].length, n = b.getParent().$.rowIndex,
                t = h(k, n, b);
            if (c) {
                var A;
                try {
                    var C = parseInt(b.getAttribute("rowspan"), 10) || 1;
                    g = parseInt(b.getAttribute("colspan"), 10) || 1;
                    A = k["up" == c ? n - C : "down" == c ? n + C : n]["left" == c ? t - g : "right" == c ? t + g : t]
                } catch (G) {
                    return !1
                }
                if (!A || b.$ == A) return !1;
            ...
            c = b.getDocument();
            var F = n, C = A = 0, I = !d && new CKEDITOR.dom.documentFragment(c), H = 0;
            for (c = 0; c < e.length; c++) {
                g = e[c];
                var K = g.getParent(), D = g.getFirst(), N = g.$.colSpan, R = g.$.rowSpan, K = K.$.rowIndex,
                    P = h(k, K, g), H = H + N * R, C = Math.max(C, P - t + N);
                A = Math.max(A, K - n + R);
                d || (N = g, (R = N.getBogus()) && R.remove(), N.trim(), g.getChildren().count() && (K == F || !D || D.isBlockBoundary && D.isBlockBoundary({br: 1}) || (F = I.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !F || F.is && F.is("br") || I.append("br")), g.moveChildren(I)), c ? g.remove() : g.setHtml(""));
                F = K
            }
            if (d) return A * C == H;
            I.moveChildren(b);
        ...
        function g(b, c) {
            ...
            if (c) return !0;
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(f),
                k = e.$.rowIndex, l = h(g, k, d), m = d.$.rowSpan, n;
            if (1 < m) {
                n = Math.ceil(m / 2);
                for (var m = Math.floor(m / 2), e = k + n, f = new CKEDITOR.dom.element(f.$.rows[e]), g = h(g, e), t, e = d.clone(), k = 0; k < g.length; k++) if (t = g[k], t.parentNode == f.$ && k > l) {
                    e.insertBefore(new CKEDITOR.dom.element(t));
                    break
                } else t = null;
                t || f.append(e)
            } else for (m = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()), t = h(g, k), l = 0; l < t.length; l++) t[l].rowSpan++;
            e.appendBogus();
            d.$.rowSpan = n;
            e.$.rowSpan = m;
        ...
        function n(b, c) {
            ...
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(f),
                g = h(f, e.$.rowIndex, d), k = d.$.colSpan;
        ...
        CKEDITOR.plugins.tabletools = {
            requires: "table,dialog,contextmenu", init: function (c) {
                ...
                var p = c.lang.table;
                t("cellProperties", new CKEDITOR.dialogCommand("cellProperties", h({
                ...
                t("columnDelete", h({
                    requiredContent: "table", exec: function (b) {
                        ...
                        for (var e = CKEDITOR.tools.buildTableMap(b), g, h, k = [], l = 0, m = e.length; l < m; l++) for (var n = 0, q = e[l].length; n < q; n++) e[l][n] == c.$ && (g = n), e[l][n] == d.$ && (h = n);
                ...
                t("columnInsertBefore", h({
                    requiredContent: "table", exec: function (a) {
                        a = a.getSelection();
                        d(a, !0)
                    }
                }));
                t("columnInsertAfter", h({
                    requiredContent: "table", exec: function (a) {
                        a = a.getSelection();
                        d(a)
                    }
                ...
                c.addMenuItems && c.addMenuItems({
                    ...
                    tablecell_insertAfter: {
                        label: p.cell.insertAfter, group: "tablecell", command: "cellInsertAfter", order: 10
                    },
                    tablecell_delete: {label: p.cell.deleteCell, group: "tablecell", command: "cellDelete", order: 15},
                    tablecell_merge: {label: p.cell.merge, group: "tablecell", command: "cellMerge", order: 16},
                    ...
                    tablecell_split_horizontal: {
                        label: p.cell.splitHorizontal, group: "tablecell", command: "cellHorizontalSplit", order: 19
                    },
                    ...
                    tablerow: {
                        label: p.row.menu, group: "tablerow", order: 1, getItems: function () {
                            return {
                    ...
                    tablerow_insertBefore: {
                        label: p.row.insertBefore, group: "tablerow", command: "rowInsertBefore", order: 5
                    },
                    ...
                    tablerow_delete: {label: p.row.deleteRow, group: "tablerow", command: "rowDelete", order: 15},
                    tablecolumn: {
                        label: p.column.menu, group: "tablecolumn", order: 1, getItems: function () {
                            return {
                    ...
                    tablecolumn_insertBefore: {
                        label: p.column.insertBefore, group: "tablecolumn", command: "columnInsertBefore", order: 5
                    },
        ...
        for (var e = -1, b = [], c = 0; c < a.length; c++) {
            e++;
            !b[e] && (b[e] = []);
            for (var d = -1, m = 0; m < a[c].cells.length; m++) {
                var l = a[c].cells[m];
                for (d++; b[e][d];) d++;
                for (var f = isNaN(l.colSpan) ? 1 : l.colSpan, l = isNaN(l.rowSpan) ? 1 : l.rowSpan, h = 0; h < l; h++) {
                    b[e + h] || (b[e + h] = []);
                    for (var k = 0; k < f; k++) b[e + h][d + k] = a[c].cells[m]
                }
                d += f - 1
            }
        }
        ...
        function a(a) {
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) || e(a), k = 0; k < h.length; k++) {
                    var m = h[k];
                    if ("/" != m) {
                        "string" == typeof m && (m = h[k] = {name: m});
                        var v, p = m.groups;
                        if (p) for (var w = 0; w < p.length; w++) v = p[w], (v = g[v]) && f(m, v);
                        (v = g[m.name]) && f(m, v)
                    }
                }
                return h
            ...
            function c() {
                var b = {}, e, f, g;
                for (e in a.ui.items) f = a.ui.items[e], g = f.toolbar || "others", g = g.split(","), f = g[0], g = parseInt(g[1] || -1, 10), b[f] || (b[f] = []), b[f].push({
                    name: e,
                    order: g
                });
            ...
            function h(a) {
                var b = [], c, d, e;
                for (c = 0; c < a.length; ++c) d = a[c], e = {}, "/" == d ? b.push(d) : CKEDITOR.tools.isArray(d) ? (f(e, CKEDITOR.tools.clone(d)), b.push(e)) : d.items && (f(e, CKEDITOR.tools.clone(d.items)), e.name = d.name, b.push(e));
                return b
            }
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (d) {
                var e, l = function (a, b) {
                    var c, g = "rtl" == d.lang.dir, n = d.config.toolbarGroupCycling, t = g ? 37 : 39, g = g ? 39 : 37,
                        n = void 0 === n || n;
                    switch (b) {
                        case 9:
                        case CKEDITOR.SHIFT + 9:
                            for (; !c || !c.items.length;) if (c = 9 == b ? (c ? c.next : a.toolbar.next) || d.toolbox.toolbars[0] : (c ? c.previous : a.toolbar.previous) || d.toolbox.toolbars[d.toolbox.toolbars.length - 1], c.items.length) for (a = c.items[e ? c.items.length - 1 : 0]; a && !a.focus;) (a = e ? a.previous : a.next) || (c = 0);
                            a && a.focus();
                            return !1;
                        case t:
                            c = a;
                ...
                d.on("uiSpace", function (c) {
                    if (c.data.space == d.config.toolbarLocation) {
                        ...
                        var e = CKEDITOR.tools.getNextId(),
                            ...
                            e = !1 !== d.config.toolbarStartupExpanded, g, m;
                        ...
                        for (var t = d.toolbox.toolbars, r = a(d), q = 0; q < r.length; q++) {
                            var v, p = 0, w, z = r[q], B;
                            if (z) if (g && (k.push("\x3c/span\x3e"), m = g = 0), "/" === z) k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                B = z.items || z;
                                for (var u = 0; u < B.length; u++) {
                                    ...
                                    if (y) {
                                        var x = function (a) {
                                            a = a.render(d, k);
                                            A = p.items.push(a) - 1;
                                            0 < A && (a.previous = p.items[A - 1], a.previous.next = a);
                                            a.toolbar = p;
                                            a.onkey = l;
                                            a.onfocus = function () {
                                        ...
                                        if (y.type == CKEDITOR.UI_SEPARATOR) m = g && y; else {
                                            E = !1 !== y.canGroup;
                                            if (!p) {
                                                v = CKEDITOR.tools.getNextId();
                                                p = {id: v, items: []};
                                                w = z.name && (d.lang.toolbar.toolbarGroups[z.name] || z.name);
                                                k.push('\x3cspan id\x3d"', v, '" class\x3d"cke_toolbar"', w ? ' aria-labelledby\x3d"' + v + '_label"' : "", ' role\x3d"toolbar"\x3e');
                                                w && k.push('\x3cspan id\x3d"', v, '_label" class\x3d"cke_voice_label"\x3e', w, "\x3c/span\x3e");
                                                k.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                                                var A = t.push(p) - 1;
                                                0 < A && (p.previous = t[A - 1], p.previous.next = p)
                                            }
                                            E ? g || (k.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), g = 1) : g && (k.push("\x3c/span\x3e"), g = 0);
                                            m && (x(m), m = 0);
                                            x(y)
                                        }
                                    }
                        ...
                        if (d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            k.push('\x3ca title\x3d"' + (e ? d.lang.toolbar.toolbarCollapse : d.lang.toolbar.toolbarExpand) + '" id\x3d"' + d.ui.spaceId("toolbar_collapser") + '" tabIndex\x3d"-1" class\x3d"cke_toolbox_collapser');
                            e || k.push(" cke_toolbox_collapser_min");
                            k.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + C + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e', "\x3c/a\x3e")
                        }
                        k.push("\x3c/span\x3e");
                        c.data.html += k.join("")
                    }
                ...
                d.on("destroy", function () {
                    if (this.toolbox) {
                        var a, b = 0, c, d, e;
                        for (a = this.toolbox.toolbars; b < a.length; b++) for (d = a[b].items, c = 0; c < d.length; c++) e = d[c], e.clickFn && CKEDITOR.tools.removeFunction(e.clickFn), e.keyDownFn && CKEDITOR.tools.removeFunction(e.keyDownFn)
                    }
                });
        ...
        var a = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], e = {8: 1, 46: 1};
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                ...
                var g = c.undoManager = new b(c), l = g.editingHandler = new m(g), t = c.addCommand("undo", {
                    exec: function () {
                ...
                g.onChange = function () {
                    t.setState(g.undoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
                ...
                c.ui.addButton && (c.ui.addButton("Undo", {
                    ...
                    label: c.lang.undo.redo, command: "redo", toolbar: "undo,20"
                }));
        ...
        function a(a) {
            function b(a) {
                ...
                g.attachListener(g, "keyup", function () {
                    ...
                    c && (1 != b.count() || b.getItem(0).getCustomData("retain") || b.getItem(0).remove(1), c = !1)
                })
            }
            ...
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (b) {
                    ...
                    var f = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
                        ...
                        h = CKEDITOR.dom.element.createFromHtml('\x3ciframe src\x3d"' + f + '" frameBorder\x3d"0"\x3e\x3c/iframe\x3e');
                    ...
                    if (n) {
                        var g = CKEDITOR.tools.getNextId(),
                            t = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e' + n + "\x3c/span\x3e");
                        f.append(t, 1);
            ...
            $: function () {
                ...
                setData: function (a, c) {
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady"); else {
                        ...
                        e._.dataStore = {id: 1};
                        var f = e.config, h = f.fullPage, k = f.docType,
                        ...
                        var n = f.baseHref ? '\x3cbase href\x3d"' + f.baseHref + '" data-cke-temp\x3d"1" /\x3e' : "";
                        ...
                        h ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = k + a) : a = f.docType + '\x3chtml dir\x3d"' + f.contentsLangDirection + '" lang\x3d"' + (f.contentsLanguage || e.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (f.bodyId ? ' id\x3d"' + f.bodyId + '"' : "") + (f.bodyClass ? ' class\x3d"' + f.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
